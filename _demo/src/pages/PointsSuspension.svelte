...
<div class="documentation">
    ...
    <h2>Description</h2>
    <p>Les<strong>points de suspension</strong> (ellipsis) sont utilisés pour tronquer un texte trop long pour être entièrement affiché dans l’espace prévu. Ils indiquent qu’il y a une suite à lire, et sont accompagnés d’une petite flèche bleue cliquable qui permet d’afficher la suite de ce texte.</p>
...
<div class="backstop-test">
    ...
    <h3>2- Texte court sur une ligne</h3>
    <div class="mb-32" id="exemplePointsSuspension3">
        <utd-points-suspension nb-lignes="1">
