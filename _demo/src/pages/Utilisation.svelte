...
<CodeSource codeSource="<script src='https://cdn.jsdelivr.net/gh/MTESSDev/utd-webcomponents@1.9.0/dist/js/utd-webcomponents.min.js'></script>">
</CodeSource>   
...
<CodeSource codeSource="<link rel='stylesheet' href='https://cdn.jsdelivr.net/gh/MTESSDev/utd-webcomponents@1.9.0/dist/css/utd-webcomponents.min.css'>">
</CodeSource>   
...
<CodeSource codeSource="<script src='/js/utd-webcomponents.min.js?v=1.9.0' relative-base-path='/utd/'></script>">
</CodeSource>   

<h3>Chargement du css</h3>
<p>Charger le css dans la balise <span class="utd-emphase-gris">head</span> après le css de votre projet.</p>
<CodeSource codeSource="<link rel='stylesheet' href='/css/utd-webcomponents.min.css?v=1.9.0'>">
</CodeSource>
