...
<p>Charger le css dans la balise <span class="utd-emphase-gris">head</span> <strong>avant</strong> le css de votre projet.</p>
<CodeSource codeSource="<link rel='stylesheet' href='/css/utd-webcomponents.min.css?v=1.9.3'>">
</CodeSource>
...
<CodeSource titre="Code source" codeSource="<script src='/js/utd-webcomponents.min.js?v=1.9.3'></script>">
</CodeSource>   

<CodeSource titre="Code source (avec chemin relatif)" codeSource="<script src='/js/utd-webcomponents.min.js?v=1.9.3' relative-base-path='/utd/'></script>">
</CodeSource>   
