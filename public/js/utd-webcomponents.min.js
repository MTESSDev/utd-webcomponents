var utd = (function (exports) {
   ...
   function create_fragment$1(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         link = element("link");
         this.c = noop;
         add_location(span0, file$1, 29, 4, 1175);
         attr_dev(span1, "aria-hidden", "true");
         attr_dev(span1, "class", "utd-icone-svg chevron-bleu-piv");
         add_location(span1, file$1, 30, 4, 1201);
         attr_dev(span2, "class", "utd-sr-only");
         add_location(span2, file$1, 31, 4, 1272);
         ...
         /*idMenu*/
         ctx[3]);
         add_location(a, file$1, 28, 2, 1054);
         ...
         /*idTitreMenu*/
         ctx[4]);
         add_location(span3, file$1, 36, 2, 1354);
         add_location(slot, file$1, 38, 4, 1531);
         attr_dev(div, "id",
         /*idMenu*/
         ctx[3]);
         ...
         /*afficher*/
         ctx[2]);
         add_location(div, file$1, 37, 2, 1458);
         ...
         /*afficher*/
         ctx[2]);
         add_location(nav, file$1, 27, 0, 962);
         attr_dev(link, "rel", "stylesheet");
         attr_dev(link, "href", "/css/utd-webcomponents.min.css");
         add_location(link, file$1, 41, 0, 1566);
       },
       l: function claim(nodes) {
         throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
       },
   ...
   var file = "src\\librairie\\components\\menuVerticalItem.svelte"; // (213:2) {:else}
   ...
   function create_else_block(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         /*label*/
         ctx[2]);
         add_location(span, file, 214, 6, 6566);
         attr_dev(a, "href",
         /*href*/
         ctx[3]);
         ...
         /*indextab*/
         ctx[4]);
         add_location(a, file, 213, 4, 6408);
       },
       m: function mount(target, anchor) {
   ...
   function create_if_block(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         add_location(span0, file, 204, 6, 6089);
         attr_dev(span1, "aria-hidden", "true");
         attr_dev(span1, "class", "utd-icone-svg chevron-bleu-piv");
         add_location(span1, file, 205, 6, 6117);
         attr_dev(a, "role", "menuitem");
         attr_dev(a, "href",
         /*href*/
         ctx[3]);
         ...
         /*indextab*/
         ctx[4]);
         add_location(a, file, 203, 4, 5866);
       },
       m: function mount(target, anchor) {
         insert_dev(target, a, anchor);
         append_dev(a, span0);
   ...
   function create_if_block_1(ctx) {
     ...
     var block = {
       c: function create() {
         div = element("div");
         slot = element("slot");
         add_location(slot, file, 209, 8, 6353);
         attr_dev(div, "id",
         /*idSousMenu*/
         ctx[8]);
         attr_dev(div, "role", "menu");
         attr_dev(div, "class", "sous-menu");
         add_location(div, file, 208, 6, 6231);
       },
       m: function mount(target, anchor) {
         insert_dev(target, div, anchor);
         append_dev(div, slot);
   ...
   function create_fragment(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         /*estactif*/
         ctx[0] === 'true' ? 'active' : ''));
         add_location(div, file, 201, 0, 5707);
         attr_dev(link, "rel", "stylesheet");
         attr_dev(link, "href", "/css/utd-webcomponents.min.css");
         add_location(link, file, 218, 0, 6631);
       },
       l: function claim(nodes) {
         throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
       },
