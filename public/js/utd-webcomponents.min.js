var utd = (function (exports) {
   ...
   if (typeof HTMLElement === 'function') {
     SvelteElement = /*#__PURE__*/function (_HTMLElement) {
       ...
       var _super2 = _createSuper$9(SvelteElement);
   ...
   var file$8 = "src\\librairie\\components\\accordeon.svelte"; // (27:10) {#if titre}
   ...
   function create_if_block_2$3(ctx) {
     ...
     dispatch_dev("SvelteRegisterBlock", {
       ...
       type: "if",
       source: "(27:10) {#if titre}",
       ctx: ctx
     });
     return block;
   } // (24:4) <svelte:element this={tagtitre} class="titre">
   ...
   function create_dynamic_element$1(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         add_location(slot, file$8, 29, 10, 939);
         attr_dev(span0, "class", "titre");
         add_location(span0, file$8, 25, 8, 846);
         attr_dev(span1, "class", span1_class_value = "utd-icone-svg " + (
         /*reduit*/
         ctx[0] === 'false' ? 'moins' : 'plus'));
         add_location(span1, file$8, 31, 8, 993);
         ...
         /*reduit*/
         ctx[0] === 'false');
         add_location(button, file$8, 24, 6, 706);
         set_attributes(svelte_element, svelte_element_data);
         add_location(svelte_element, file$8, 23, 4, 651);
       },
       m: function mount(target, anchor) {
     ...
     dispatch_dev("SvelteRegisterBlock", {
       ...
       source: "(24:4) <svelte:element this={tagtitre} class=\\\"titre\\\">",
       ctx: ctx
     });
     return block;
   } // (38:6) {#if reduit === 'false'}
   ...
   function create_if_block$5(ctx) {
     ...
     var block = {
       c: function create() {
         div = element("div");
         if_block.c();
         add_location(div, file$8, 38, 8, 1214);
       },
       m: function mount(target, anchor) {
   ...
   function create_else_block$2(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         t = space();
         slot1 = element("slot");
         add_location(slot0, file$8, 42, 10, 1334);
         attr_dev(slot1, "name", "contenu");
         add_location(slot1, file$8, 43, 10, 1355);
       },
       m: function mount(target, anchor) {
   ...
   function create_fragment$8(ctx) {
     ...
     var if_block1 =
     /*reduit*/
     ctx[0] === 'false' && create_if_block$5(ctx);
     var block = {
       c: function create() {
         div2 = element("div");
         div0 = element("div");
   ...
   var Accordeon = /*#__PURE__*/function (_SvelteElement) {
     ...
     var _super = _createSuper$8(Accordeon);
   ...
   var file$7 = "src\\librairie\\components\\avis.svelte"; // (26:6) {#if contenu}
   ...
   function create_fragment$7(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         /*type*/
         ctx[1]);
         add_location(div0, file$7, 18, 4, 451);
         attr_dev(div1, "class", "zone-icone");
         add_location(div1, file$7, 17, 2, 421);
         attr_dev(h2, "class", "titre");
         add_location(h2, file$7, 21, 4, 561);
         attr_dev(slot, "name", "contenu");
         add_location(slot, file$7, 28, 6, 703);
         attr_dev(div2, "class", "texte");
         add_location(div2, file$7, 24, 4, 611);
         attr_dev(div3, "class", "contenu zone-html");
         add_location(div3, file$7, 20, 2, 524);
         ...
         /*role*/
         ctx[3]);
         add_location(div4, file$7, 16, 0, 367);
         attr_dev(link, "rel", "stylesheet");
         attr_dev(link, "href", "/css/utd-webcomponents.min.css");
         add_location(link, file$7, 33, 0, 760);
       },
       l: function claim(nodes) {
         throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
       },
   ...
   var Avis = /*#__PURE__*/function (_SvelteElement) {
     ...
     var _super = _createSuper$7(Avis);
   ...
   var file$6 = "src\\librairie\\components\\champForm.svelte";
   ...
   function create_fragment$6(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         link = element("link");
         this.c = noop;
         add_location(slot, file$6, 227, 2, 6833);
         attr_dev(div, "class", "utd-form-group");
         add_location(div, file$6, 226, 0, 6801);
         attr_dev(link, "rel", "stylesheet");
         attr_dev(link, "href", "/css/utd-webcomponents.min.css");
         add_location(link, file$6, 231, 0, 6854);
       },
       l: function claim(nodes) {
         throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
       },
   ...
   var texteObligatoire = "Obligatoire.";
   ...
   function instance$6($$self, $$props, $$invalidate) {
     ...
     var idPrecision = Utils.genererId();
     var idErreur = Utils.genererId();
     ...
     function gererLabel() {
       ...
       if (label) {
         ...
         if (libelle) {
           var _element = document.createElement('label');

           _element.innerText = libelle;

           _element.setAttribute('for', elementChamp.id);

           thisComponent.prepend(_element);
           label = _element;
         }
       }
     }
       ...
       if (label) {
         ...
         if (precision) {
           if (elementPrecision) {
             ...
             var indicateurObligatoire = thisComponent.querySelector(".utd-icone-champ-requis");
     ...
     function ajusterChampAriaDescribedBy() {
       ...
       var valeurActuelle = elementChamp.getAttribute('aria-describedby') || '';
       var nouvelleValeur = '';
       ...
       if (label) {
         ...
         if (obligatoire === 'true') {
           if (!indicateurObligatoire) {
             ...
             span.innerHTML = "<span aria-hidden=\"true\">&nbsp;*</span><span class=\"utd-sr-only\">&nbsp;".concat(texteObligatoire, "</span>");
             label.after(span);
           }
         } else {
           if (indicateurObligatoire) {
     ...
     $$self.$capture_state = function () {
       return {
         ...
         idErreur: idErreur,
         texteObligatoire: texteObligatoire,
   ...
   var ChampForm = /*#__PURE__*/function (_SvelteElement) {
     ...
     var _super = _createSuper$6(ChampForm);
   ...
   var file$5 = "src\\librairie\\components\\dialogueModal.svelte"; // (152:0) {#if estModaleAffichee}
   ...
   function create_if_block$3(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         add_location(div0, file$5, 152, 2, 5156);
         attr_dev(span, "aria-hidden", "true");
         attr_dev(span, "class", "utd-icone-svg x-fermer-bleu");
         add_location(span, file$5, 177, 8, 6178);
         attr_dev(button, "type", "button");
         attr_dev(button, "class", "close");
         attr_dev(button, "aria-label",
         /*srTexteBoutonFermer*/
         ctx[11]);
         add_location(button, file$5, 171, 8, 6008);
         attr_dev(h1, "id",
         /*idEntete*/
         ctx[9]);
         attr_dev(h1, "class", "titre-dialog");
         add_location(h1, file$5, 187, 10, 6505);
         attr_dev(div1, "class", div1_class_value = "entete " + (
         /*type*/
         ctx[0] ? 'avec-type' : ''));
         add_location(div1, file$5, 183, 8, 6330);
         add_location(slot0, file$5, 192, 10, 6653);
         attr_dev(slot1, "name", "contenu");
         add_location(slot1, file$5, 193, 10, 6672);
         attr_dev(div2, "class", "corps");
         attr_dev(div2, "id",
         /*idCorps*/
         ctx[10]);
         add_location(div2, file$5, 191, 8, 6609);
         attr_dev(div3, "class", "principal");
         add_location(div3, file$5, 182, 6, 6297);
         attr_dev(div4, "class", "conteneur");
         add_location(div4, file$5, 170, 4, 5975);
         ...
         /*estaffichagelateral*/
         ctx[5] === 'true' ? 'affichage-lateral' : '') + " " + (
         /*estaffichageboutonsinline*/
         ctx[4] === 'true' ? 'boutons-inline' : ''));
         attr_dev(div5, "id",
         /*idModale*/
         ctx[8]);
         attr_dev(div5, "aria-modal", "true");
         attr_dev(div5, "role", "dialog");
         add_location(div5, file$5, 153, 2, 5236);
       },
       m: function mount(target, anchor) {
         ...
         if (!mounted) {
           ...
           /*click_handler*/
           ctx[26], false, false, false), listen_dev(button, "click",
           /*click_handler_1*/
           ctx[27], false, false, false), listen_dev(div5, "click",
           /*clickModale*/
       ...
       p: function update(ctx, dirty) {
         ...
         58 && div5_class_value !== (div5_class_value = "utd-component utd-dialog " + (
         /*estfenetremessage*/
         ctx[1] === 'true' ? 'fenetre-message' : '') + " " + (
         /*estboutonstextelong*/
         ctx[3] === 'true' ? 'boutons-texte-long' : '') + " " + (
     ...
     dispatch_dev("SvelteRegisterBlock", {
       ...
       type: "if",
       source: "(152:0) {#if estModaleAffichee}",
       ctx: ctx
     });
     return block;
   } // (185:10) {#if type}
   ...
   function create_if_block_2$2(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         ctx[0]);
         attr_dev(span, "aria-hidden", "true");
         add_location(span, file$5, 185, 12, 6412);
       },
       m: function mount(target, anchor) {
     ...
     dispatch_dev("SvelteRegisterBlock", {
       ...
       type: "if",
       source: "(185:10) {#if type}",
       ctx: ctx
     });
     return block;
   } // (196:8) {#if Utils.slotExiste(slots, 'pied')}
   ...
   function create_if_block_1$3(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         add_location(slot, file$5, 197, 12, 6802);
         attr_dev(div, "class", "pied");
         add_location(div, file$5, 196, 10, 6770);
       },
       m: function mount(target, anchor) {
         insert_dev(target, div, anchor);
         append_dev(div, slot);
     ...
     dispatch_dev("SvelteRegisterBlock", {
       ...
       type: "if",
       source: "(196:8) {#if Utils.slotExiste(slots, 'pied')}",
       ctx: ctx
     });
     return block;
   }
   ...
   function create_fragment$5(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         attr_dev(link, "rel", "stylesheet");
         attr_dev(link, "href", "/css/utd-webcomponents.min.css");
         add_location(link, file$5, 205, 0, 6912);
       },
       l: function claim(nodes) {
         throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
       },
   ...
   function instance$5($$self, $$props, $$invalidate) {
     ...
     function masquerModale(raisonFermetureModale) {
       $$invalidate(6, estModaleAffichee = false);
     ...
     function toggleAfficher() {
       if (mounted) {
         if (afficher === 'true') {
           ...
           $$invalidate(6, estModaleAffichee = true);
         } else {
     ...
     $$self.$$set = function ($$props) {
       ...
       if ('srboutonfermer' in $$props) $$invalidate(23, srboutonfermer = $$props.srboutonfermer);
       if ('idfocusouverture' in $$props) $$invalidate(24, idfocusouverture = $$props.idfocusouverture);
       if ('idfocus' in $$props) $$invalidate(25, idfocus = $$props.idfocus);
       if ('estboutonstextelong' in $$props) $$invalidate(3, estboutonstextelong = $$props.estboutonstextelong);
       if ('estaffichageboutonsinline' in $$props) $$invalidate(4, estaffichageboutonsinline = $$props.estaffichageboutonsinline);
       if ('estaffichagelateral' in $$props) $$invalidate(5, estaffichagelateral = $$props.estaffichagelateral);
     };
     ...
     $$self.$inject_state = function ($$props) {
       ...
       if ('estaffichageboutonsinline' in $$props) $$invalidate(4, estaffichageboutonsinline = $$props.estaffichageboutonsinline);
       if ('estaffichagelateral' in $$props) $$invalidate(5, estaffichagelateral = $$props.estaffichagelateral);
       if ('estModaleAffichee' in $$props) $$invalidate(6, estModaleAffichee = $$props.estModaleAffichee);
     ...
     return [type, estfenetremessage, titre, estboutonstextelong, estaffichageboutonsinline, estaffichagelateral, estModaleAffichee, slots, idModale, idEntete, idCorps, srTexteBoutonFermer, masquerModale, animationAffichageOuverture, animationAffichageFermeture, keydown, clickModale, finAnimationFermeture, ajusterModaleDebutAffichage, ajusterModaleFinAffichage, afficher, raisonfermeture, lang, srboutonfermer, idfocusouverture, idfocus, click_handler, click_handler_1];
   }

   var DialogueModal = /*#__PURE__*/function (_SvelteElement) {
     _inherits(DialogueModal, _SvelteElement);

     var _super = _createSuper$5(DialogueModal);
     ...
     function DialogueModal(options) {
       ...
       init(_assertThisInitialized(_this), {
         ...
         estaffichageboutonsinline: 4,
         estaffichagelateral: 5
       }, null, [-1, -1]);
   ...
   var file$4 = "src\\librairie\\components\\hautPage.svelte";
   ...
   function create_fragment$4(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         add_location(span, file$4, 72, 6, 2140);
         attr_dev(div0, "class", "contenu");
         add_location(div0, file$4, 71, 4, 2111);
         attr_dev(button, "type", "button");
         attr_dev(button, "class", "utd-btn primaire");
         attr_dev(button, "title",
         /*title*/
         ctx[0]);
         add_location(button, file$4, 70, 2, 2014);
         attr_dev(div1, "class", "utd-component utd-hautpage");
         add_location(div1, file$4, 69, 0, 1970);
         attr_dev(link, "rel", "stylesheet");
         attr_dev(link, "href", "/css/utd-webcomponents.min.css");
         add_location(link, file$4, 77, 0, 2254);
       },
       l: function claim(nodes) {
         throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
       },
   ...
   var HautPage = /*#__PURE__*/function (_SvelteElement) {
     ...
     var _super = _createSuper$4(HautPage);
   ...
   var file$3 = "src\\librairie\\components\\infobulle.svelte"; // (93:2) {#if $$slots["texte-lie"]}
   ...
   function create_if_block_4$1(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         add_location(slot, file$3, 93, 54, 3315);
         attr_dev(span, "class", "texte-lie");
         add_location(span, file$3, 93, 4, 3265);
       },
       m: function mount(target, anchor) {
         insert_dev(target, span, anchor);
     ...
     dispatch_dev("SvelteRegisterBlock", {
       ...
       type: "if",
       source: "(93:2) {#if $$slots[\\\"texte-lie\\\"]}",
       ctx: ctx
     });
     return block;
   } // (108:2) {#if afficher}
   ...
   function create_if_block$2(ctx) {
     ...
     function select_block_type(ctx, dirty) {
       ...
       if (
       /*contenu*/
       ctx[4]) return create_if_block_2$1;
     }
     ...
     var block = {
       c: function create() {
         ...
         add_location(div, file$3, 108, 4, 3804);
         attr_dev(span0, "class", "utd-sr-only");
         add_location(span0, file$3, 124, 10, 4317);
         add_location(span1, file$3, 125, 10, 4382);
         attr_dev(h1, "id",
         /*idEntete*/
         ctx[8]);
         attr_dev(h1, "tabindex", "-1");
         add_location(h1, file$3, 123, 8, 4273);
         attr_dev(span2, "aria-hidden", "true");
         attr_dev(span2, "class", "utd-icone-svg x-fermer-bleu");
         add_location(span2, file$3, 137, 10, 4683);
         attr_dev(button, "type", "button");
         attr_dev(button, "class", "close");
         attr_dev(button, "aria-label", button_aria_label_value =
         /*srboutonfermer*/
         ctx[3] ||
         /*srTexteDefautBoutonFermer*/
         ctx[11]);
         add_location(button, file$3, 131, 8, 4499);
         attr_dev(span3, "class", "utd-container entete");
         add_location(span3, file$3, 122, 6, 4228);
         attr_dev(span4, "class", "corps");
         add_location(span4, file$3, 144, 8, 4879);
         attr_dev(span5, "class", "utd-container conteneur-corps");
         add_location(span5, file$3, 143, 6, 4825);
         ...
         add_location(span6, file$3, 109, 4, 3863);
       },
       m: function mount(target, anchor) {
         insert_dev(target, div, anchor);
         insert_dev(target, t0, anchor);
         ...
         if (!mounted) {
           ...
           /*masquerModale*/
           ctx[13], false, false, false), listen_dev(span6, "keydown",
           /*keydown*/
           ctx[14], false, false, false), listen_dev(span6, "introend",
           /*conserverFocusInfobulle*/
           ctx[16], false, false, false), listen_dev(span6, "outroend",
           /*finAnimationFermeture*/
   ...
   function create_if_block_2$1(ctx) {
     ...
     dispatch_dev("SvelteRegisterBlock", {
       ...
       type: "if",
       source: "(152:12) {#if contenu}",
       ctx: ctx
     });
     return block;
   } // (146:10) {#if Utils.slotExiste(slots, 'contenu')}
   ...
   function create_if_block_1$2(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         add_location(slot, file$3, 146, 12, 4965);
         add_location(span, file$3, 147, 12, 5020);
       },
       m: function mount(target, anchor) {
     ...
     dispatch_dev("SvelteRegisterBlock", {
       ...
       type: "if",
       source: "(146:10) {#if Utils.slotExiste(slots, 'contenu')}",
       ctx: ctx
     });
     return block;
   }
   ...
   function create_fragment$3(ctx) {
     ...
     var if_block0 =
     /*$$slots*/
     ctx[17]["texte-lie"] && create_if_block_4$1(ctx);
     var if_block1 =
     /*afficher*/
     ...
     var block = {
       c: function create() {
         ...
         add_location(span0, file$3, 98, 10, 3625);
         attr_dev(span1, "aria-hidden", "true");
         attr_dev(span1, "class", "puce");
         add_location(span1, file$3, 97, 8, 3575);
         attr_dev(span2, "class", "conteneur-puce");
         add_location(span2, file$3, 96, 6, 3536);
         attr_dev(button, "type", "button");
         attr_dev(button, "aria-label", button_aria_label_value =
         /*srboutonouvrir*/
         ctx[2] ||
         /*srTexteDefautBoutonOuvrir*/
         ctx[10]);
         attr_dev(button, "class", "tooltip-toggle");
         add_location(button, file$3, 95, 42, 3400);
         attr_dev(span3, "class", "conteneur-tooltip");
         add_location(span3, file$3, 95, 2, 3360);
         attr_dev(span4, "class", "utd-component utd-infobulle");
         add_location(span4, file$3, 91, 0, 3187);
         attr_dev(link, "rel", "stylesheet");
         attr_dev(link, "href", "/css/utd-webcomponents.min.css");
         add_location(link, file$3, 161, 0, 5296);
       },
       l: function claim(nodes) {
         throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
       },
   ...
   function instance$3($$self, $$props, $$invalidate) {
     ...
     var srTexteDefautBoutonOuvrir = lang === "fr" ? "Afficher l'aide contextuelle" : "Show help about";
     var srTexteDefautBoutonFermer = lang === "fr" ? "Fermer" : "Close";
     var thisComponent = get_current_component();
     var html;
     var body;
     var slots = [];
     ...
     */
     ...
     function assignerHtmlSlotContenu() {
       if (slots.length) {
         ...
         if (slotContenu) {
           ...
           if (contenuHtml) {
             $$invalidate(6, htmlSlotContenu = contenuHtml);
           }
         }
       }
     }
     ...
     $$self.$$set = function ($$props) {
       ...
       if ('srtitre' in $$props) $$invalidate(19, srtitre = $$props.srtitre);
       if ('srboutonouvrir' in $$props) $$invalidate(2, srboutonouvrir = $$props.srboutonouvrir);
       if ('srboutonfermer' in $$props) $$invalidate(3, srboutonfermer = $$props.srboutonfermer);
       if ('contenu' in $$props) $$invalidate(4, contenu = $$props.contenu);
     };
     ...
     $$self.$capture_state = function () {
       return {
         ...
         srTexteDefautBoutonOuvrir: srTexteDefautBoutonOuvrir,
         srTexteDefautBoutonFermer: srTexteDefautBoutonFermer,
         thisComponent: thisComponent,
         html: html,
         body: body,
         slots: slots,
     ...
     $$self.$inject_state = function ($$props) {
       ...
       if ('htmlSlotContenu' in $$props) $$invalidate(6, htmlSlotContenu = $$props.htmlSlotContenu);
     };
     ...
     return [afficher, titre, srboutonouvrir, srboutonfermer, contenu, slots, htmlSlotContenu, idModale, idEntete, srTexteTitre, srTexteDefautBoutonOuvrir, srTexteDefautBoutonFermer, afficherModale, masquerModale, keydown, finAnimationFermeture, conserverFocusInfobulle, $$slots, lang, srtitre];
   }

   var Infobulle = /*#__PURE__*/function (_SvelteElement) {
     _inherits(Infobulle, _SvelteElement);

     var _super = _createSuper$3(Infobulle);
   ...
   var file$2 = "src\\librairie\\components\\menuVertical.svelte";
   ...
   function create_fragment$2(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         link = element("link");
         this.c = noop;
         add_location(span0, file$2, 29, 4, 1175);
         attr_dev(span1, "aria-hidden", "true");
         attr_dev(span1, "class", "utd-icone-svg chevron-bleu-piv");
         add_location(span1, file$2, 30, 4, 1201);
         attr_dev(span2, "class", "utd-sr-only");
         add_location(span2, file$2, 31, 4, 1272);
         ...
         /*idMenu*/
         ctx[3]);
         add_location(a, file$2, 28, 2, 1054);
         ...
         /*idTitreMenu*/
         ctx[4]);
         add_location(span3, file$2, 36, 2, 1354);
         add_location(slot, file$2, 38, 4, 1531);
         attr_dev(div, "id",
         /*idMenu*/
         ctx[3]);
         ...
         /*afficher*/
         ctx[2]);
         add_location(div, file$2, 37, 2, 1458);
         ...
         /*afficher*/
         ctx[2]);
         add_location(nav, file$2, 27, 0, 962);
         attr_dev(link, "rel", "stylesheet");
         attr_dev(link, "href", "/css/utd-webcomponents.min.css");
         add_location(link, file$2, 41, 0, 1566);
       },
       l: function claim(nodes) {
         throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
       },
   ...
   var MenuVertical = /*#__PURE__*/function (_SvelteElement) {
     ...
     var _super = _createSuper$2(MenuVertical);
   ...
   var file$1 = "src\\librairie\\components\\menuVerticalItem.svelte"; // (213:2) {:else}
   ...
   function create_else_block$1(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         /*label*/
         ctx[2]);
         add_location(span, file$1, 214, 6, 6566);
         attr_dev(a, "href",
         /*href*/
         ctx[3]);
         ...
         /*estactif*/
         ctx[0] === 'true' ? 'page' : null);
         attr_dev(a, "tabindex",
         /*indextab*/
         ctx[4]);
         add_location(a, file$1, 213, 4, 6408);
       },
       m: function mount(target, anchor) {
   ...
   function create_if_block$1(ctx) {
     ...
     var if_block =
     /*afficher*/
     ctx[1] === 'true' && create_if_block_1$1(ctx);
     var block = {
       c: function create() {
         a = element("a");
         span0 = element("span");
         ...
         add_location(span0, file$1, 204, 6, 6089);
         attr_dev(span1, "aria-hidden", "true");
         attr_dev(span1, "class", "utd-icone-svg chevron-bleu-piv");
         add_location(span1, file$1, 205, 6, 6117);
         attr_dev(a, "role", "menuitem");
         attr_dev(a, "href",
         /*href*/
         ctx[3]);
         ...
         /*indextab*/
         ctx[4]);
         add_location(a, file$1, 203, 4, 5866);
       },
       m: function mount(target, anchor) {
         insert_dev(target, a, anchor);
         append_dev(a, span0);
   ...
   function create_if_block_1$1(ctx) {
     ...
     var block = {
       c: function create() {
         div = element("div");
         slot = element("slot");
         add_location(slot, file$1, 209, 8, 6353);
         attr_dev(div, "id",
         /*idSousMenu*/
         ctx[8]);
         attr_dev(div, "role", "menu");
         attr_dev(div, "class", "sous-menu");
         add_location(div, file$1, 208, 6, 6231);
       },
       m: function mount(target, anchor) {
         insert_dev(target, div, anchor);
         append_dev(div, slot);
   ...
   function create_fragment$1(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         /*estactif*/
         ctx[0] === 'true' ? 'active' : ''));
         add_location(div, file$1, 201, 0, 5707);
         attr_dev(link, "rel", "stylesheet");
         attr_dev(link, "href", "/css/utd-webcomponents.min.css");
         add_location(link, file$1, 218, 0, 6631);
       },
       l: function claim(nodes) {
         throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
       },
   ...
   function instance$1($$self, $$props, $$invalidate) {
     ...
     var _$$props$estactif = $$props.estactif,
         estactif = _$$props$estactif === void 0 ? 'false' : _$$props$estactif;
     var _$$props$afficher = $$props.afficher,
         afficher = _$$props$afficher === void 0 ? 'false' : _$$props$afficher;
     ...
     onMount(function () {
       $$invalidate(0, estactif = estElementActif());
     ...
     function toggleAfficher() {
       $$invalidate(1, afficher = afficher === 'true' ? 'false' : 'true');
     }
     ...
     var writable_props = ['label', 'href', 'estactif', 'afficher', 'indextab', 'animer', 'focus'];
     Object.keys($$props).forEach(function (key) {
     ...
     $$self.$$set = function ($$props) {
       ...
       if ('estactif' in $$props) $$invalidate(0, estactif = $$props.estactif);
     ...
     return [estactif, afficher, label, href, indextab, animer, possedeEnfants, niveau, idSousMenu, toggleAfficher, onKeyDown, onFocus, focus];
   }

   var MenuVerticalItem = /*#__PURE__*/function (_SvelteElement) {
     _inherits(MenuVerticalItem, _SvelteElement);

     var _super = _createSuper$1(MenuVerticalItem);
     ...
     _createClass(MenuVerticalItem, [{
       ...
       key: "observedAttributes",
       get: function get() {
         return ["label", "href", "estactif", "afficher", "indextab", "animer", "focus"];
       }
     }]);
   ...
   var file = "src\\librairie\\components\\section.svelte"; // (37:4) {:else}
   ...
   function create_dynamic_element_1(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         slot = element("slot");
         attr_dev(slot, "name", "titre");
         add_location(slot, file, 41, 8, 1424);
         set_attributes(svelte_element, svelte_element_data);
         add_location(svelte_element, file, 37, 6, 1312);
       },
       m: function mount(target, anchor) {
         insert_dev(target, svelte_element, anchor);
   ...
   function create_dynamic_element(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         span = element("span");
         attr_dev(slot, "name", "titre");
         add_location(slot, file, 32, 10, 1150);
         attr_dev(span, "class", "utd-icone-svg chevron-blanc");
         add_location(span, file, 33, 8, 1193);
         attr_dev(button, "type", "button");
         attr_dev(button, "class", "");
         attr_dev(button, "aria-controls",
         /*idContenu*/
         ...
         /*reduit*/
         ctx[0] === 'false');
         add_location(button, file, 28, 6, 947);
         set_attributes(svelte_element, svelte_element_data);
         add_location(svelte_element, file, 27, 4, 892);
       },
       m: function mount(target, anchor) {
         insert_dev(target, svelte_element, anchor);
         append_dev(svelte_element, button);
   ...
   function create_if_block(ctx) {
     ...
     var block = {
       c: function create() {
         div = element("div");
         slot = element("slot");
         add_location(slot, file, 50, 6, 1656);
         add_location(div, file, 49, 4, 1607);
       },
       m: function mount(target, anchor) {
         insert_dev(target, div, anchor);
         append_dev(div, slot);
   ...
   function create_fragment(ctx) {
     ...
     ctx[1] === 'false' ||
     /*reduit*/
     ctx[0] === 'false') && create_if_block(ctx);
     var block = {
       c: function create() {
         div2 = element("div");
         div0 = element("div");
         ...
         this.c = noop;
         attr_dev(div0, "class", "entete");
         add_location(div0, file, 25, 2, 833);
         attr_dev(div1, "id",
         /*idContenu*/
         ctx[5]);
         attr_dev(div1, "class", "contenu");
         add_location(div1, file, 47, 2, 1506);
         ...
         /*bordure*/
         ctx[3] === 'true' ? 'bordure' : ''));
         add_location(div2, file, 24, 0, 670);
         attr_dev(link, "rel", "stylesheet");
         attr_dev(link, "href", "/css/utd-webcomponents.min.css");
         add_location(link, file, 57, 0, 1710);
       },
       l: function claim(nodes) {
         throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
       },
