var utd = (function (exports) {
   ...
   if (typeof HTMLElement === 'function') {
     SvelteElement = /*#__PURE__*/function (_HTMLElement) {
       ...
       var _super2 = _createSuper$6(SvelteElement);
   ...
   var file$5 = "src\\librairie\\components\\accordeon.svelte"; // (45:8) {#if titre}
   ...
   function create_if_block$4(ctx) {
     ...
     var block = {
       c: function create() {
         div = element("div");
         if_block.c();
         add_location(div, file$5, 55, 6, 1523);
       },
       m: function mount(target, anchor) {
   ...
   function create_else_block$1(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         add_location(slot, file$5, 59, 10, 1643);
       },
       m: function mount(target, anchor) {
   ...
   function create_fragment$5(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         add_location(slot, file$5, 47, 8, 1306);
         attr_dev(span0, "class", "titre");
         add_location(span0, file$5, 43, 6, 1221);
         attr_dev(span1, "class", span1_class_value = "utd-icone-svg " + (
         /*afficher*/
         ctx[0] ? 'moins' : 'plus'));
         add_location(span1, file$5, 49, 6, 1356);
         ...
         /*afficher*/
         ctx[0]);
         add_location(button, file$5, 42, 4, 1107);
         attr_dev(div0, "class", "entete");
         add_location(div0, file$5, 41, 2, 1081);
         attr_dev(div1, "id",
         /*idContenu*/
         ctx[3]);
         attr_dev(div1, "class", "contenu");
         add_location(div1, file$5, 53, 4, 1454);
         attr_dev(div2, "class", div2_class_value = "utd-component utd-accordeon " + (
         /*afficher*/
         ctx[0] ? 'ouvert' : ''));
         add_location(div2, file$5, 40, 0, 1008);
         attr_dev(link, "rel", "stylesheet");
         attr_dev(link, "href", "/css/utd-webcomponents.min.css");
         add_location(link, file$5, 67, 0, 1734);
       },
   ...
   var Accordeon = /*#__PURE__*/function (_SvelteElement) {
     ...
     var _super = _createSuper$5(Accordeon);
   ...
   var file$4 = "src\\librairie\\components\\avis.svelte"; // (26:6) {#if contenu}
   ...
   function create_fragment$4(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         /*type*/
         ctx[1]);
         add_location(div0, file$4, 18, 4, 451);
         attr_dev(div1, "class", "zone-icone");
         add_location(div1, file$4, 17, 2, 421);
         attr_dev(h2, "class", "titre d-flex justify-content-between align-self-center");
         add_location(h2, file$4, 21, 4, 561);
         attr_dev(slot, "name", "contenu");
         add_location(slot, file$4, 28, 6, 746);
         attr_dev(div2, "class", "texte");
         add_location(div2, file$4, 24, 4, 660);
         attr_dev(div3, "class", "contenu zone-html");
         add_location(div3, file$4, 20, 2, 524);
         ...
         /*role*/
         ctx[3]);
         add_location(div4, file$4, 16, 0, 367);
         attr_dev(link, "rel", "stylesheet");
         attr_dev(link, "href", "/css/utd-webcomponents.min.css");
         add_location(link, file$4, 33, 0, 803);
       },
       l: function claim(nodes) {
         throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
       },
   ...
   var Avis = /*#__PURE__*/function (_SvelteElement) {
     ...
     var _super = _createSuper$4(Avis);
   ...
   var file$3 = "src\\librairie\\components\\dialogueModal.svelte"; // (152:0) {#if estModaleAffichee}
   ...
   function create_if_block$2(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         add_location(div0, file$3, 152, 2, 5156);
         attr_dev(span, "aria-hidden", "true");
         attr_dev(span, "class", "utd-icone-svg x-fermer-bleu");
         add_location(span, file$3, 177, 8, 6178);
         attr_dev(button, "type", "button");
         attr_dev(button, "class", "close");
         attr_dev(button, "aria-label",
         /*srTexteBoutonFermer*/
         ctx[11]);
         add_location(button, file$3, 171, 8, 6008);
         attr_dev(h1, "id",
         /*idEntete*/
         ctx[9]);
         attr_dev(h1, "class", "titre-dialog");
         add_location(h1, file$3, 187, 10, 6505);
         attr_dev(div1, "class", div1_class_value = "entete " + (
         /*type*/
         ctx[0] ? 'avec-type' : ''));
         add_location(div1, file$3, 183, 8, 6330);
         attr_dev(slot, "name", "contenu");
         add_location(slot, file$3, 192, 10, 6653);
         attr_dev(div2, "class", "corps");
         attr_dev(div2, "id",
         /*idCorps*/
         ctx[10]);
         add_location(div2, file$3, 191, 8, 6609);
         attr_dev(div3, "class", "principal");
         add_location(div3, file$3, 182, 6, 6297);
         attr_dev(div4, "class", "conteneur");
         add_location(div4, file$3, 170, 4, 5975);
         ...
         add_location(div5, file$3, 153, 2, 5236);
       },
       m: function mount(target, anchor) {
   ...
   function create_if_block_2$1(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         ctx[0]);
         attr_dev(span, "aria-hidden", "true");
         add_location(span, file$3, 185, 12, 6412);
       },
       m: function mount(target, anchor) {
   ...
   function create_if_block_1$2(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         add_location(slot, file$3, 196, 12, 6783);
         attr_dev(div, "class", "pied");
         add_location(div, file$3, 195, 10, 6751);
       },
       m: function mount(target, anchor) {
         insert_dev(target, div, anchor);
         append_dev(div, slot);
   ...
   function create_fragment$3(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         attr_dev(link, "rel", "stylesheet");
         attr_dev(link, "href", "/css/utd-webcomponents.min.css");
         add_location(link, file$3, 204, 0, 6893);
       },
       l: function claim(nodes) {
         throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
       },
   ...
   var DialogueModal = /*#__PURE__*/function (_SvelteElement) {
     ...
     var _super = _createSuper$3(DialogueModal);
   ...
   var file$2 = "src\\librairie\\components\\hautPage.svelte";
   ...
   function create_fragment$2(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         add_location(span, file$2, 72, 6, 2140);
         attr_dev(div0, "class", "contenu");
         add_location(div0, file$2, 71, 4, 2111);
         attr_dev(button, "type", "button");
         attr_dev(button, "class", "utd-btn primaire");
         attr_dev(button, "title",
         /*title*/
         ctx[0]);
         add_location(button, file$2, 70, 2, 2014);
         attr_dev(div1, "class", "utd-component utd-hautpage");
         add_location(div1, file$2, 69, 0, 1970);
         attr_dev(link, "rel", "stylesheet");
         attr_dev(link, "href", "/css/utd-webcomponents.min.css");
         add_location(link, file$2, 77, 0, 2254);
       },
       l: function claim(nodes) {
         throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
       },
   ...
   var HautPage = /*#__PURE__*/function (_SvelteElement) {
     ...
     var _super = _createSuper$2(HautPage);
   ...
   var file$1 = "src\\librairie\\components\\infobulle.svelte"; // (101:2) {#if $$slots["texte-lie"]}
   ...
   function create_if_block_4(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         add_location(slot, file$1, 101, 54, 3409);
         attr_dev(span, "class", "texte-lie");
         add_location(span, file$1, 101, 4, 3359);
       },
       m: function mount(target, anchor) {
         insert_dev(target, span, anchor);
   ...
   function create_if_block$1(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         add_location(div, file$1, 116, 4, 3874);
         attr_dev(span0, "class", "utd-sr-only");
         add_location(span0, file$1, 132, 10, 4387);
         add_location(span1, file$1, 133, 10, 4452);
         attr_dev(h1, "id",
         /*idEntete*/
         ctx[6]);
         attr_dev(h1, "tabindex", "-1");
         add_location(h1, file$1, 131, 8, 4343);
         attr_dev(span2, "aria-hidden", "true");
         attr_dev(span2, "class", "utd-icone-svg x-fermer-bleu");
         add_location(span2, file$1, 145, 10, 4729);
         attr_dev(button, "type", "button");
         attr_dev(button, "class", "close");
         attr_dev(button, "aria-label",
         /*srTexteBoutonFermer*/
         ctx[9]);
         add_location(button, file$1, 139, 8, 4569);
         attr_dev(span3, "class", "utd-container entete");
         add_location(span3, file$1, 130, 6, 4298);
         attr_dev(span4, "class", "corps");
         add_location(span4, file$1, 152, 8, 4925);
         attr_dev(span5, "class", "utd-container conteneur-corps");
         add_location(span5, file$1, 151, 6, 4871);
         ...
         add_location(span6, file$1, 117, 4, 3933);
       },
       m: function mount(target, anchor) {
         insert_dev(target, div, anchor);
         insert_dev(target, t0, anchor);
   ...
   function create_if_block_1$1(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         add_location(slot, file$1, 154, 12, 5011);
         add_location(span, file$1, 155, 12, 5066);
       },
       m: function mount(target, anchor) {
         insert_dev(target, slot, anchor);
         insert_dev(target, t, anchor);
   ...
   function create_fragment$1(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         add_location(span0, file$1, 106, 10, 3695);
         attr_dev(span1, "aria-hidden", "true");
         attr_dev(span1, "class", "puce");
         add_location(span1, file$1, 105, 8, 3645);
         attr_dev(span2, "class", "conteneur-puce");
         add_location(span2, file$1, 104, 6, 3606);
         attr_dev(button, "type", "button");
         attr_dev(button, "aria-label",
         /*srTexteBoutonOuvrir*/
         ctx[8]);
         attr_dev(button, "class", "tooltip-toggle");
         add_location(button, file$1, 103, 42, 3494);
         attr_dev(span3, "class", "conteneur-tooltip");
         add_location(span3, file$1, 103, 2, 3454);
         attr_dev(span4, "class", "utd-component utd-infobulle");
         add_location(span4, file$1, 99, 0, 3281);
         attr_dev(link, "rel", "stylesheet");
         attr_dev(link, "href", "/css/utd-webcomponents.min.css");
         add_location(link, file$1, 169, 0, 5342);
       },
       l: function claim(nodes) {
         throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
       },
   ...
   var file = "src\\librairie\\components\\menuSecondaireElement.svelte"; // (67:2) {:else}
   ...
   var MenuSecondaireElement = /*#__PURE__*/function (_SvelteElement) {
     _inherits(MenuSecondaireElement, _SvelteElement);

     var _super = _createSuper(MenuSecondaireElement);

     function MenuSecondaireElement(options) {
       var _this;

       _classCallCheck(this, MenuSecondaireElement);
     ...
     _createClass(MenuSecondaireElement, [{
       key: "label",
       get: function get() {
         return this.$$.ctx[2];
       },
     ...
     return MenuSecondaireElement;
   }(SvelteElement);

   customElements.define("utd-menu-vertical-item", MenuSecondaireElement);
