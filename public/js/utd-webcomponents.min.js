var utd = (function (exports) {
   ...
   function create_else_block(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         add_location(slot, file$4, 59, 10, 1646);
       },
       m: function mount(target, anchor) {
   ...
   function create_fragment$4(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         add_location(link, file$4, 67, 0, 1737);
       },
   ...
   var file$2 = "src\\librairie\\components\\dialogueModal.svelte"; // (141:0) {#if estModaleAffichee}
   ...
   function create_if_block$1(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         add_location(div0, file$2, 141, 2, 4747);
         attr_dev(span, "aria-hidden", "true");
         attr_dev(span, "class", "utd-icone-svg x-fermer-bleu");
         add_location(span, file$2, 166, 8, 5706);
         attr_dev(button, "type", "button");
         attr_dev(button, "class", "close");
         attr_dev(button, "aria-label",
         /*srTexteBoutonFermer*/
         ctx[10]);
         add_location(button, file$2, 160, 8, 5536);
         attr_dev(h1, "id",
         /*idEntete*/
         ctx[8]);
         attr_dev(h1, "class", "titre-dialog");
         add_location(h1, file$2, 176, 10, 6033);
         attr_dev(div1, "class", div1_class_value = "entete " + (
         /*type*/
         ctx[0] ? 'avec-type' : ''));
         add_location(div1, file$2, 172, 8, 5858);
         attr_dev(slot, "name", "contenu");
         add_location(slot, file$2, 181, 10, 6180);
         attr_dev(div2, "class", "corps");
         attr_dev(div2, "id",
         /*idCorps*/
         ctx[9]);
         add_location(div2, file$2, 180, 8, 6136);
         attr_dev(div3, "class", "principal");
         add_location(div3, file$2, 171, 6, 5825);
         attr_dev(div4, "class", "conteneur");
         add_location(div4, file$2, 159, 4, 5503);
         ...
         /*estaffichagelateral*/
         ctx[4] === 'true' ? 'affichage-lateral' : ''));
         attr_dev(div5, "id",
         /*idModale*/
         ctx[7]);
         attr_dev(div5, "aria-modal", "true");
         attr_dev(div5, "role", "dialog");
         add_location(div5, file$2, 142, 2, 4827);
       },
       m: function mount(target, anchor) {
         ...
         if (!mounted) {
           ...
           /*clickModale*/
           ctx[15], false, false, false), listen_dev(div5, "keydown",
           /*keydown*/
           ctx[14], false, false, false), listen_dev(div5, "introstart",
       ...
       p: function update(ctx, dirty) {
         ...
         if (!current || dirty[0] &
         /*estfenetremessage, estboutonstextelong, estaffichagelateral*/
         26 && div5_class_value !== (div5_class_value = "utd-component utd-dialog " + (
         /*estfenetremessage*/
         ctx[1] === 'true' ? 'fenetre-message' : '') + " " + (
         /*estboutonstextelong*/
         ctx[3] === 'true' ? 'boutons-texte-long' : '') + " " + (
     ...
     dispatch_dev("SvelteRegisterBlock", {
       ...
       type: "if",
       source: "(141:0) {#if estModaleAffichee}",
       ctx: ctx
     });
     return block;
   } // (174:10) {#if type}
   ...
   function create_if_block_2$1(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         ctx[0]);
         attr_dev(span, "aria-hidden", "true");
         add_location(span, file$2, 174, 12, 5940);
       },
       m: function mount(target, anchor) {
     ...
     dispatch_dev("SvelteRegisterBlock", {
       ...
       type: "if",
       source: "(174:10) {#if type}",
       ctx: ctx
     });
     return block;
   } // (184:8) {#if Utils.slotExiste(slots, 'pied')}
   ...
   function create_if_block_1$1(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         add_location(slot, file$2, 185, 12, 6310);
         attr_dev(div, "class", "pied");
         add_location(div, file$2, 184, 10, 6278);
       },
       m: function mount(target, anchor) {
         insert_dev(target, div, anchor);
         append_dev(div, slot);
     ...
     dispatch_dev("SvelteRegisterBlock", {
       ...
       type: "if",
       source: "(184:8) {#if Utils.slotExiste(slots, 'pied')}",
       ctx: ctx
     });
     return block;
   }
   ...
   function create_fragment$2(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         attr_dev(link, "rel", "stylesheet");
         attr_dev(link, "href", "/css/utd-webcomponents.min.css");
         add_location(link, file$2, 193, 0, 6420);
       },
       l: function claim(nodes) {
         throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
       },
   ...
   function instance$2($$self, $$props, $$invalidate) {
     ...
     var _$$props$estaffichage = $$props.estaffichagelateral,
         estaffichagelateral = _$$props$estaffichage === void 0 ? 'false' : _$$props$estaffichage;
     ...
     function masquerModale(raisonFermetureModale) {
       $$invalidate(5, estModaleAffichee = false);
     ...
     function toggleAfficher() {
       if (mounted) {
         if (afficher === 'true') {
           ...
           $$invalidate(5, estModaleAffichee = true);
         } else {
     ...
     var writable_props = ['afficher', 'type', 'estfenetremessage', 'raisonfermeture', 'titre', 'lang', 'srboutonfermer', 'idfocus', 'estboutonstextelong', 'estaffichagelateral'];
     Object.keys($$props).forEach(function (key) {
     ...
     $$self.$$set = function ($$props) {
       ...
       if ('lang' in $$props) $$invalidate(21, lang = $$props.lang);
       if ('srboutonfermer' in $$props) $$invalidate(22, srboutonfermer = $$props.srboutonfermer);
       if ('idfocus' in $$props) $$invalidate(23, idfocus = $$props.idfocus);
       if ('estboutonstextelong' in $$props) $$invalidate(3, estboutonstextelong = $$props.estboutonstextelong);
       if ('estaffichagelateral' in $$props) $$invalidate(4, estaffichagelateral = $$props.estaffichagelateral);
     };
     ...
     $$self.$inject_state = function ($$props) {
       ...
       if ('estboutonstextelong' in $$props) $$invalidate(3, estboutonstextelong = $$props.estboutonstextelong);
       if ('estaffichagelateral' in $$props) $$invalidate(4, estaffichagelateral = $$props.estaffichagelateral);
       if ('estModaleAffichee' in $$props) $$invalidate(5, estModaleAffichee = $$props.estModaleAffichee);
     ...
     return [type, estfenetremessage, titre, estboutonstextelong, estaffichagelateral, estModaleAffichee, slots, idModale, idEntete, idCorps, srTexteBoutonFermer, masquerModale, animationAffichageOuverture, animationAffichageFermeture, keydown, clickModale, finAnimationFermeture, ajusterModaleDebutAffichage, ajusterModaleFinAffichage, afficher, raisonfermeture, lang, srboutonfermer, idfocus, click_handler, click_handler_1];
   }
   ...
   var DialogueModal = /*#__PURE__*/function (_SvelteElement) {
     ...
     _createClass(DialogueModal, [{
       ...
       key: "observedAttributes",
       get: function get() {
         return ["afficher", "type", "estfenetremessage", "raisonfermeture", "titre", "lang", "srboutonfermer", "idfocus", "estboutonstextelong", "estaffichagelateral"];
       }
     }]);
