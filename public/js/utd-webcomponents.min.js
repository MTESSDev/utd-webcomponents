  ...
  */
  var customElements = {
    define: function define(tagName, CustomElement) {
      var CustomElementWrapper = /*#__PURE__*/function (_CustomElement) {
        ...
        var _super = _createSuper$c(CustomElementWrapper);
  ...
  if (typeof HTMLElement === 'function') {
    SvelteElement = /*#__PURE__*/function (_HTMLElement) {
      ...
      var _super2 = _createSuper$b(SvelteElement);
  ...
  var file$a = "src\\librairie\\components\\accordeon.svelte"; // (29:10) {#if titre}
  ...
  function create_dynamic_element$1(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        add_location(slot, file$a, 31, 10, 1011);
        attr_dev(span0, "class", "titre");
        add_location(span0, file$a, 27, 8, 918);
        attr_dev(span1, "class", span1_class_value = "utd-icone-svg " + (
        /*reduit*/
        ctx[0] === 'false' ? 'moins' : 'plus'));
        add_location(span1, file$a, 33, 8, 1065);
        ...
        /*reduit*/
        ctx[0] === 'false');
        add_location(button, file$a, 26, 6, 778);
        set_attributes(svelte_element, svelte_element_data);
        add_location(svelte_element, file$a, 25, 4, 723);
      },
      m: function mount(target, anchor) {
  ...
  function create_if_block$7(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        add_location(div, file$a, 40, 8, 1286);
      },
      m: function mount(target, anchor) {
  ...
  function create_else_block$2(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        t = space();
        slot1 = element("slot");
        add_location(slot0, file$a, 44, 12, 1432);
        attr_dev(slot1, "name", "contenu");
        add_location(slot1, file$a, 45, 12, 1455);
      },
      m: function mount(target, anchor) {
  ...
  function create_fragment$a(ctx) {
    ...
    var if_block1 =
    /*reduit*/
    ctx[0] === 'false' && create_if_block$7(ctx);
    var block = {
      c: function create() {
        div2 = element("div");
        div0 = element("div");
  ...
  var Accordeon = /*#__PURE__*/function (_SvelteElement) {
    ...
    var _super = _createSuper$a(Accordeon);
  ...
  var file$9 = "src\\librairie\\components\\avis.svelte"; // (22:6) {#if contenu}
  ...
  function create_fragment$9(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        /*type*/
        ctx[1]);
        add_location(div0, file$9, 14, 4, 347);
        attr_dev(div1, "class", "zone-icone");
        add_location(div1, file$9, 13, 2, 317);
        attr_dev(h2, "class", "titre");
        add_location(h2, file$9, 17, 4, 457);
        add_location(slot0, file$9, 24, 6, 599);
        attr_dev(slot1, "name", "contenu");
        add_location(slot1, file$9, 25, 6, 615);
        attr_dev(div2, "class", "texte");
        add_location(div2, file$9, 20, 4, 507);
        attr_dev(div3, "class", "contenu zone-html");
        add_location(div3, file$9, 16, 2, 420);
        attr_dev(div4, "class", div4_class_value = "utd-component utd-avis " +
        /*type*/
        ctx[1]);
        attr_dev(div4, "tabindex", "0");
        add_location(div4, file$9, 12, 0, 257);
        attr_dev(link, "rel", "stylesheet");
        attr_dev(link, "href", "/css/utd-webcomponents.min.css");
        add_location(link, file$9, 30, 0, 672);
      },
      l: function claim(nodes) {
        throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
      },
  ...
  var Avis = /*#__PURE__*/function (_SvelteElement) {
    ...
    var _super = _createSuper$9(Avis);
  ...
  var file$8 = "src\\librairie\\components\\champForm.svelte";
  ...
  function create_fragment$8(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        link = element("link");
        this.c = noop;
        add_location(slot, file$8, 384, 0, 11428);
        attr_dev(link, "rel", "stylesheet");
        attr_dev(link, "href", "/css/utd-webcomponents.min.css");
        add_location(link, file$8, 386, 0, 11439);
      },
      l: function claim(nodes) {
        throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
      },
  ...
  var ChampForm = /*#__PURE__*/function (_SvelteElement) {
    ...
    var _super = _createSuper$8(ChampForm);
  ...
  var file$7 = "src\\librairie\\components\\dialogueModal.svelte"; // (171:0) {#if estModaleAffichee}
  ...
  function create_if_block$5(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        add_location(div0, file$7, 171, 2, 6195);
        attr_dev(span, "aria-hidden", "true");
        attr_dev(span, "class", "utd-icone-svg x-fermer-bleu");
        add_location(span, file$7, 195, 8, 7181);
        attr_dev(button, "type", "button");
        attr_dev(button, "class", "close");
        attr_dev(button, "aria-label",
        /*srBoutonFermer*/
        ctx[3]);
        add_location(button, file$7, 189, 8, 7016);
        attr_dev(h1, "id",
        /*idEntete*/
        ctx[10]);
        attr_dev(h1, "class", "titre-dialog");
        add_location(h1, file$7, 205, 10, 7508);
        attr_dev(div1, "class", div1_class_value = "entete " + (
        /*type*/
        ctx[1] ? 'avec-type' : ''));
        add_location(div1, file$7, 201, 8, 7333);
        add_location(slot0, file$7, 210, 10, 7656);
        attr_dev(slot1, "name", "contenu");
        add_location(slot1, file$7, 211, 10, 7675);
        attr_dev(div2, "class", "corps");
        attr_dev(div2, "id",
        /*idCorps*/
        ctx[11]);
        add_location(div2, file$7, 209, 8, 7612);
        attr_dev(div3, "class", "principal");
        add_location(div3, file$7, 200, 6, 7300);
        attr_dev(div4, "class", "conteneur");
        add_location(div4, file$7, 188, 4, 6983);
        ...
        add_location(div5, file$7, 172, 2, 6275);
      },
      m: function mount(target, anchor) {
  ...
  function create_if_block_2$3(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        ctx[1]);
        attr_dev(span, "aria-hidden", "true");
        add_location(span, file$7, 203, 12, 7415);
      },
      m: function mount(target, anchor) {
  ...
  function create_if_block_1$4(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        add_location(slot, file$7, 215, 12, 7805);
        attr_dev(div, "class", "pied");
        add_location(div, file$7, 214, 10, 7773);
      },
      m: function mount(target, anchor) {
        insert_dev(target, div, anchor);
        append_dev(div, slot);
  ...
  function create_fragment$7(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        attr_dev(link, "rel", "stylesheet");
        attr_dev(link, "href", "/css/utd-webcomponents.min.css");
        add_location(link, file$7, 223, 0, 7915);
      },
      l: function claim(nodes) {
        throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
      },
  ...
  var DialogueModal = /*#__PURE__*/function (_SvelteElement) {
    ...
    var _super = _createSuper$7(DialogueModal);
  ...
  var file$6 = "src\\librairie\\components\\hautPage.svelte";
  ...
  function create_fragment$6(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        add_location(span, file$6, 72, 6, 2140);
        attr_dev(div0, "class", "contenu");
        add_location(div0, file$6, 71, 4, 2111);
        attr_dev(button, "type", "button");
        attr_dev(button, "class", "utd-btn primaire");
        attr_dev(button, "title",
        /*title*/
        ctx[0]);
        add_location(button, file$6, 70, 2, 2014);
        attr_dev(div1, "class", "utd-component utd-hautpage");
        add_location(div1, file$6, 69, 0, 1970);
        attr_dev(link, "rel", "stylesheet");
        attr_dev(link, "href", "/css/utd-webcomponents.min.css");
        add_location(link, file$6, 77, 0, 2254);
      },
      l: function claim(nodes) {
        throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
      },
  ...
  var HautPage = /*#__PURE__*/function (_SvelteElement) {
    ...
    var _super = _createSuper$6(HautPage);
  ...
  var file$5 = "src\\librairie\\components\\infobulle.svelte"; // (85:2) {#if $$slots["texte-lie"]}
  ...
  function create_if_block_4$2(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        add_location(slot, file$5, 85, 54, 3203);
        attr_dev(span, "class", "texte-lie");
        add_location(span, file$5, 85, 4, 3153);
      },
      m: function mount(target, anchor) {
        insert_dev(target, span, anchor);
  ...
  function create_if_block$4(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        add_location(div, file$5, 100, 4, 3663);
        attr_dev(span0, "class", "utd-sr-only");
        add_location(span0, file$5, 116, 10, 4176);
        add_location(span1, file$5, 117, 10, 4236);
        attr_dev(h1, "id",
        /*idEntete*/
        ctx[9]);
        attr_dev(h1, "tabindex", "-1");
        add_location(h1, file$5, 115, 8, 4132);
        attr_dev(span2, "aria-hidden", "true");
        attr_dev(span2, "class", "utd-icone-svg x-fermer-bleu");
        add_location(span2, file$5, 129, 10, 4508);
        attr_dev(button, "type", "button");
        attr_dev(button, "class", "close");
        attr_dev(button, "aria-label",
        /*srBoutonFermer*/
        ctx[4]);
        add_location(button, file$5, 123, 8, 4353);
        attr_dev(span3, "class", "utd-container entete");
        add_location(span3, file$5, 114, 6, 4087);
        attr_dev(span4, "class", "corps");
        add_location(span4, file$5, 136, 8, 4704);
        attr_dev(span5, "class", "utd-container conteneur-corps");
        add_location(span5, file$5, 135, 6, 4650);
        ...
        add_location(span6, file$5, 101, 4, 3722);
      },
      m: function mount(target, anchor) {
        insert_dev(target, div, anchor);
        insert_dev(target, t0, anchor);
  ...
  function create_if_block_1$3(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        add_location(slot, file$5, 138, 12, 4790);
        add_location(span, file$5, 139, 12, 4845);
      },
      m: function mount(target, anchor) {
        insert_dev(target, slot, anchor);
        insert_dev(target, t, anchor);
  ...
  function create_fragment$5(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        add_location(span0, file$5, 90, 10, 3484);
        attr_dev(span1, "aria-hidden", "true");
        attr_dev(span1, "class", "puce");
        add_location(span1, file$5, 89, 8, 3434);
        attr_dev(span2, "class", "conteneur-puce");
        add_location(span2, file$5, 88, 6, 3395);
        attr_dev(button, "type", "button");
        attr_dev(button, "aria-label",
        /*srBoutonOuvrir*/
        ctx[3]);
        attr_dev(button, "class", "tooltip-toggle");
        add_location(button, file$5, 87, 42, 3288);
        attr_dev(span3, "class", "conteneur-tooltip");
        add_location(span3, file$5, 87, 2, 3248);
        attr_dev(span4, "class", "utd-component utd-infobulle");
        add_location(span4, file$5, 83, 0, 3075);
        attr_dev(link, "rel", "stylesheet");
        attr_dev(link, "href", "/css/utd-webcomponents.min.css");
        add_location(link, file$5, 153, 0, 5121);
      },
      l: function claim(nodes) {
        throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
      },
  ...
  var Infobulle = /*#__PURE__*/function (_SvelteElement) {
    ...
    var _super = _createSuper$5(Infobulle);
  ...
  var file$4 = "src\\librairie\\components\\menuVertical.svelte";
  ...
  function create_fragment$4(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        link = element("link");
        this.c = noop;
        add_location(span0, file$4, 26, 4, 1166);
        attr_dev(span1, "aria-hidden", "true");
        attr_dev(span1, "class", "utd-icone-svg chevron-bleu-piv");
        add_location(span1, file$4, 27, 4, 1192);
        attr_dev(span2, "class", "utd-sr-only");
        add_location(span2, file$4, 28, 4, 1263);
        ...
        /*idMenu*/
        ctx[3]);
        add_location(a, file$4, 25, 2, 1045);
        ...
        /*idTitreMenu*/
        ctx[4]);
        add_location(span3, file$4, 33, 2, 1345);
        add_location(slot, file$4, 35, 4, 1522);
        attr_dev(div, "id",
        /*idMenu*/
        ctx[3]);
        ...
        /*afficher*/
        ctx[2]);
        add_location(div, file$4, 34, 2, 1449);
        ...
        /*afficher*/
        ctx[2]);
        add_location(nav, file$4, 24, 0, 953);
        attr_dev(link, "rel", "stylesheet");
        attr_dev(link, "href", "/css/utd-webcomponents.min.css");
        add_location(link, file$4, 38, 0, 1557);
      },
      l: function claim(nodes) {
        throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
      },
  ...
  var MenuVertical = /*#__PURE__*/function (_SvelteElement) {
    ...
    var _super = _createSuper$4(MenuVertical);
  ...
  var file$3 = "src\\librairie\\components\\menuVerticalItem.svelte"; // (213:2) {:else}
  ...
  function create_else_block$1(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        /*libelle*/
        ctx[2]);
        add_location(span, file$3, 214, 6, 6543);
        attr_dev(a, "href",
        /*href*/
        ctx[3]);
        ...
        /*indextab*/
        ctx[4]);
        add_location(a, file$3, 213, 4, 6388);
      },
      m: function mount(target, anchor) {
  ...
  function create_if_block$3(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        add_location(span0, file$3, 204, 6, 6067);
        attr_dev(span1, "aria-hidden", "true");
        attr_dev(span1, "class", "utd-icone-svg chevron-bleu-piv");
        add_location(span1, file$3, 205, 6, 6097);
        attr_dev(a, "role", "menuitem");
        attr_dev(a, "href",
        /*href*/
        ctx[3]);
        ...
        /*indextab*/
        ctx[4]);
        add_location(a, file$3, 203, 4, 5844);
      },
      m: function mount(target, anchor) {
        insert_dev(target, a, anchor);
        append_dev(a, span0);
  ...
  function create_if_block_1$2(ctx) {
    ...
    var block = {
      c: function create() {
        div = element("div");
        slot = element("slot");
        add_location(slot, file$3, 209, 8, 6333);
        attr_dev(div, "id",
        /*idSousMenu*/
        ctx[8]);
        attr_dev(div, "role", "menu");
        attr_dev(div, "class", "sous-menu");
        add_location(div, file$3, 208, 6, 6211);
      },
      m: function mount(target, anchor) {
        insert_dev(target, div, anchor);
        append_dev(div, slot);
  ...
  function create_fragment$3(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        /*actif*/
        ctx[1] === 'true' ? 'active' : ''));
        add_location(div, file$3, 201, 0, 5688);
        attr_dev(link, "rel", "stylesheet");
        attr_dev(link, "href", "/css/utd-webcomponents.min.css");
        add_location(link, file$3, 218, 0, 6610);
      },
      l: function claim(nodes) {
        throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
      },
  ...
  var MenuVerticalItem = /*#__PURE__*/function (_SvelteElement) {
    ...
    var _super = _createSuper$3(MenuVerticalItem);
  ...
  var file$2 = "src\\librairie\\components\\section.svelte"; // (37:4) {:else}
  ...
  function create_dynamic_element_1(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        slot = element("slot");
        attr_dev(slot, "name", "titre");
        add_location(slot, file$2, 41, 8, 1424);
        set_attributes(svelte_element, svelte_element_data);
        add_location(svelte_element, file$2, 37, 6, 1312);
      },
      m: function mount(target, anchor) {
        insert_dev(target, svelte_element, anchor);
  ...
  function create_dynamic_element(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        span = element("span");
        attr_dev(slot, "name", "titre");
        add_location(slot, file$2, 32, 10, 1150);
        attr_dev(span, "class", "utd-icone-svg chevron-blanc");
        add_location(span, file$2, 33, 8, 1193);
        attr_dev(button, "type", "button");
        attr_dev(button, "class", "");
        attr_dev(button, "aria-controls",
        /*idContenu*/
        ...
        /*reduit*/
        ctx[0] === 'false');
        add_location(button, file$2, 28, 6, 947);
        set_attributes(svelte_element, svelte_element_data);
        add_location(svelte_element, file$2, 27, 4, 892);
      },
      m: function mount(target, anchor) {
        insert_dev(target, svelte_element, anchor);
        append_dev(svelte_element, button);
  ...
  function create_if_block$2(ctx) {
    ...
    var block = {
      c: function create() {
        div = element("div");
        slot = element("slot");
        add_location(slot, file$2, 50, 6, 1656);
        add_location(div, file$2, 49, 4, 1607);
      },
      m: function mount(target, anchor) {
        insert_dev(target, div, anchor);
        append_dev(div, slot);
  ...
  function create_fragment$2(ctx) {
    ...
    ctx[1] === 'false' ||
    /*reduit*/
    ctx[0] === 'false') && create_if_block$2(ctx);
    var block = {
      c: function create() {
        div2 = element("div");
        div0 = element("div");
        ...
        this.c = noop;
        attr_dev(div0, "class", "entete");
        add_location(div0, file$2, 25, 2, 833);
        attr_dev(div1, "id",
        /*idContenu*/
        ctx[5]);
        attr_dev(div1, "class", "contenu");
        add_location(div1, file$2, 47, 2, 1506);
        ...
        /*bordure*/
        ctx[3] === 'true' ? 'bordure' : ''));
        add_location(div2, file$2, 24, 0, 670);
        attr_dev(link, "rel", "stylesheet");
        attr_dev(link, "href", "/css/utd-webcomponents.min.css");
        add_location(link, file$2, 57, 0, 1710);
      },
      l: function claim(nodes) {
        throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
      },
  ...
  var Section = /*#__PURE__*/function (_SvelteElement) {
    ...
    var _super = _createSuper$2(Section);
  ...
  var file$1 = "src\\librairie\\components\\menuAncres.svelte";
  ...
  function create_if_block$1(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        add_location(h2, file$1, 35, 4, 787);
        add_location(ul, file$1, 37, 6, 884);
        attr_dev(nav, "aria-describedby", "titreTableMatieres");
        add_location(nav, file$1, 36, 4, 833);
        attr_dev(div, "class", "utd-component utd-menu-ancres");
        add_location(div, file$1, 34, 2, 738);
      },
      m: function mount(target, anchor) {
        insert_dev(target, div, anchor);
        append_dev(div, h2);
  ...
  function create_each_block(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        /*ancre*/
        ctx[4].id);
        add_location(a, file$1, 40, 12, 951);
        add_location(li, file$1, 39, 10, 933);
      },
      m: function mount(target, anchor) {
  ...
  function create_fragment$1(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        attr_dev(link, "rel", "stylesheet");
        attr_dev(link, "href", "/css/utd-webcomponents.min.css");
        add_location(link, file$1, 48, 0, 1098);
      },
      l: function claim(nodes) {
        throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
      },
  ...
  var MenuAncres = /*#__PURE__*/function (_SvelteElement) {
    ...
    var _super = _createSuper$1(MenuAncres);
  ...
  var file = "src\\librairie\\components\\pivEntete.svelte"; // (37:0) {#if passerContenu === 'true'}
  ...
  function create_if_block_8(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        add_location(a, file, 39, 8, 1364);
        attr_dev(div0, "class", "utd-passer-contenu");
        add_location(div0, file, 38, 4, 1322);
        attr_dev(div1, "class", "utd-conteneur-passer-contenu");
        add_location(div1, file, 37, 2, 1274);
      },
      m: function mount(target, anchor) {
        insert_dev(target, div1, anchor);
        append_dev(div1, div0);
  ...
  function create_if_block_7(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        add_location(span, file, 56, 12, 1967);
      },
      m: function mount(target, anchor) {
        insert_dev(target, span, anchor);
        append_dev(span, t);
  ...
  function create_if_block_6(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        add_location(slot, file, 64, 12, 2220);
        attr_dev(div, "class", "bouton-recherche");
        add_location(div, file, 63, 10, 2176);
      },
      m: function mount(target, anchor) {
        insert_dev(target, div, anchor);
        append_dev(div, slot);
  ...
  function create_if_block_3(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        t = space();
        if (if_block1) if_block1.c();
        add_location(ul, file, 69, 10, 2360);
      },
      m: function mount(target, anchor) {
  ...
  function create_if_block_5(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        /*urlLangueAlternative*/
        ctx[6]);
        add_location(a, file, 71, 18, 2424);
        add_location(li, file, 71, 14, 2420);
      },
      m: function mount(target, anchor) {
        insert_dev(target, li, anchor);
        append_dev(li, a);
  ...
  function create_if_block_4(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        /*urlNousJoindre*/
        ctx[8]);
        add_location(a, file, 74, 18, 2579);
        add_location(li, file, 74, 14, 2575);
      },
      m: function mount(target, anchor) {
        insert_dev(target, li, anchor);
        append_dev(li, a);
  ...
  function create_if_block_2(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        ctx[3]);
        attr_dev(span, "class", "description");
        add_location(span, file, 84, 10, 2861);
      },
      m: function mount(target, anchor) {
        insert_dev(target, span, anchor);
        append_dev(span, t);
  ...
  function create_if_block_1(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        add_location(slot, file, 90, 10, 3053);
        attr_dev(div, "class", "bouton-recherche");
        add_location(div, file, 89, 8, 3011);
      },
      m: function mount(target, anchor) {
        insert_dev(target, div, anchor);
        append_dev(div, slot);
  ...
  function create_if_block(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        add_location(slot, file, 96, 8, 3247);
        attr_dev(div, "class", "zone-recherche");
        add_location(div, file, 95, 6, 3209);
      },
      m: function mount(target, anchor) {
        insert_dev(target, div, anchor);
        append_dev(div, slot);
  ...
  function create_fragment(ctx) {
    ...
    var if_block6 = show_if && create_if_block(ctx);
    var block = {
      c: function create() {
        if (if_block0) if_block0.c();
        t0 = space();
        ...
        add_location(img, file, 49, 10, 1699);
        attr_dev(a0, "href",
        /*urlLogo*/
        ctx[0]);
        add_location(a0, file, 48, 8, 1667);
        attr_dev(div0, "class", "section-gauche signature-gouvernement");
        add_location(div0, file, 47, 6, 1606);
        add_location(span0, file, 54, 10, 1900);
        attr_dev(a1, "href",
        /*urlTitreSite*/
        ctx[4]);
        attr_dev(a1, "class", "titre-site");
        add_location(a1, file, 53, 8, 1844);
        attr_dev(div1, "class", "section-centre");
        add_location(div1, file, 52, 6, 1806);
        attr_dev(div2, "class", "section-droite");
        add_location(div2, file, 61, 6, 2078);
        attr_dev(div3, "class", "conteneur-sections");
        add_location(div3, file, 46, 4, 1566);
        add_location(span1, file, 82, 8, 2798);
        attr_dev(div4, "class", "titre-site");
        add_location(div4, file, 81, 6, 2764);
        attr_dev(div5, "class", "zone-titre-recherche");
        add_location(div5, file, 80, 4, 2722);
        attr_dev(div6, "class", "utd-container");
        add_location(div6, file, 45, 2, 1533);
        attr_dev(div7, "class", "utd-piv-entete");
        add_location(div7, file, 44, 0, 1501);
        attr_dev(link, "rel", "stylesheet");
        attr_dev(link, "href", "/css/utd-webcomponents.min.css");
        add_location(link, file, 105, 0, 3337);
      },
      l: function claim(nodes) {
        throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
      },
  ...
  var PivEntete = /*#__PURE__*/function (_SvelteElement) {
    ...
    var _super = _createSuper(PivEntete);
