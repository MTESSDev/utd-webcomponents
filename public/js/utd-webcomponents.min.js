var utd = (function (exports) {
   ...
   function create_if_block$5(ctx) {
     ...
     var block = {
       c: function create() {
         div = element("div");
         if_block.c();
         add_location(div, file$7, 35, 6, 1092);
       },
       m: function mount(target, anchor) {
   ...
   function create_else_block$1(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         t = space();
         slot1 = element("slot");
         add_location(slot0, file$7, 39, 10, 1212);
         attr_dev(slot1, "name", "contenu");
         add_location(slot1, file$7, 40, 10, 1233);
       },
       m: function mount(target, anchor) {
   ...
   function create_fragment$7(ctx) {
     ...
     var if_block1 =
     /*afficher*/
     ctx[0] === 'true' && create_if_block$5(ctx);
     var block = {
       c: function create() {
         div2 = element("div");
         div0 = element("div");
         ...
         add_location(slot, file$7, 27, 8, 853);
         attr_dev(span0, "class", "titre");
         add_location(span0, file$7, 23, 6, 768);
         attr_dev(span1, "class", span1_class_value = "utd-icone-svg " + (
         /*afficher*/
         ctx[0] === 'true' ? 'moins' : 'plus'));
         add_location(span1, file$7, 29, 6, 903);
   ...
   function instance$7($$self, $$props, $$invalidate) {
     ...
     var writable_props = ['afficher', 'titre', 'contenu'];
     ...
     return [afficher, titre, contenu, idContenu, toggleAffichageContenu];
   }
   ...
   var file = "src\\librairie\\components\\section.svelte"; // (25:8) {#if titre}
   ...
   function create_if_block(ctx) {
     ...
     var block = {
       c: function create() {
         div = element("div");
         slot = element("slot");
         add_location(slot, file, 36, 6, 1146);
         add_location(div, file, 35, 4, 1097);
       },
       m: function mount(target, anchor) {
         insert_dev(target, div, anchor);
         append_dev(div, slot);
   ...
   function create_fragment(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         this.c = noop;
         attr_dev(slot, "name", "titre");
         add_location(slot, file, 27, 8, 891);
         attr_dev(span0, "class", "titre");
         add_location(span0, file, 23, 6, 806);
         attr_dev(span1, "class", "utd-icone-svg chevron-blanc");
         add_location(span1, file, 29, 6, 941);
         attr_dev(button, "type", "button");
         attr_dev(button, "class", "");
         attr_dev(button, "aria-controls",
         /*idContenu*/
         ...
         /*afficher*/
         ctx[0] === 'true');
         add_location(button, file, 22, 4, 667);
         attr_dev(div0, "class", "entete");
         add_location(div0, file, 21, 2, 641);
         attr_dev(div1, "id",
         /*idContenu*/
         ctx[3]);
         attr_dev(div1, "class", "contenu");
         add_location(div1, file, 33, 2, 1021);
         attr_dev(div2, "class", div2_class_value = "utd-component utd-section " + (
         /*afficher*/
         ctx[0] === 'true' ? 'ouvert' : '') + " " + (
         /*bordure*/
         ctx[2] === 'true' ? 'bordure' : ''));
         add_location(div2, file, 20, 0, 521);
         attr_dev(link, "rel", "stylesheet");
         attr_dev(link, "href", "/css/utd-webcomponents.min.css");
         add_location(link, file, 43, 0, 1200);
       },
       l: function claim(nodes) {
         throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
       },
       ...
       p: function update(ctx, _ref) {
         ...
         if (!current || dirty &
         /*afficher, bordure*/
         5 && div2_class_value !== (div2_class_value = "utd-component utd-section " + (
         /*afficher*/
         ctx[0] === 'true' ? 'ouvert' : '') + " " + (
         /*bordure*/
         ctx[2] === 'true' ? 'bordure' : ''))) {
   ...
   function instance($$self, $$props, $$invalidate) {
     ...
     var writable_props = ['afficher', 'titre', 'bordure'];
     Object.keys($$props).forEach(function (key) {
     ...
     return [afficher, titre, bordure, idContenu, toggleAffichageContenu];
   }
