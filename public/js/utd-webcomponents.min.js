   ...
   function create_dynamic_element_1(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         slot = element("slot");
         attr_dev(slot, "name", "titre");
         add_location(slot, file, 41, 8, 1422);
         set_attributes(svelte_element, svelte_element_data);
         add_location(svelte_element, file, 37, 6, 1310);
       },
       m: function mount(target, anchor) {
         insert_dev(target, svelte_element, anchor);
   ...
   function create_dynamic_element(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         span = element("span");
         attr_dev(slot, "name", "titre");
         add_location(slot, file, 32, 10, 1148);
         attr_dev(span, "class", "utd-icone-svg chevron-blanc");
         add_location(span, file, 33, 8, 1191);
         attr_dev(button, "type", "button");
         attr_dev(button, "class", "");
         attr_dev(button, "aria-controls",
         /*idContenu*/
         ...
         /*reduit*/
         ctx[0] === 'false');
         add_location(button, file, 28, 6, 945);
         set_attributes(svelte_element, svelte_element_data);
         add_location(svelte_element, file, 27, 4, 890);
       },
       m: function mount(target, anchor) {
         insert_dev(target, svelte_element, anchor);
         append_dev(svelte_element, button);
   ...
   function create_if_block(ctx) {
     ...
     var block = {
       c: function create() {
         div = element("div");
         slot = element("slot");
         add_location(slot, file, 50, 6, 1654);
         add_location(div, file, 49, 4, 1605);
       },
       m: function mount(target, anchor) {
         insert_dev(target, div, anchor);
         append_dev(div, slot);
   ...
   function create_fragment(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         this.c = noop;
         attr_dev(div0, "class", "entete");
         add_location(div0, file, 25, 2, 831);
         attr_dev(div1, "id",
         /*idContenu*/
         ctx[5]);
         attr_dev(div1, "class", "contenu");
         add_location(div1, file, 47, 2, 1504);
         ...
         /*bordure*/
         ctx[3] === 'true' ? 'bordure' : ''));
         add_location(div2, file, 24, 0, 668);
         attr_dev(link, "rel", "stylesheet");
         attr_dev(link, "href", "/css/utd-webcomponents.min.css");
         add_location(link, file, 57, 0, 1708);
       },
       l: function claim(nodes) {
         throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
       },
