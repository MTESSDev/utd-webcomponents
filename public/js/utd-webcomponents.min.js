var utd = (function (exports) {
   ...
   function create_if_block(ctx) {
     ...
     var block = {
       c: function create() {
         ul = element("ul");
         slot = element("slot");
         add_location(slot, file, 36, 6, 950);
         toggle_class(ul, "visible",
         /*afficher*/
         ctx[3]);
         add_location(ul, file, 35, 4, 913);
       },
       m: function mount(target, anchor) {
   ...
   function create_fragment(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         if (if_block) if_block.c();
         this.c = noop;
         add_location(span0, file, 31, 4, 784);
         attr_dev(span1, "aria-hidden", "true");
         attr_dev(span1, "class", "utd-icone-svg chevron-bleu-piv");
         add_location(span1, file, 32, 4, 810);
         ...
         /*idMenu*/
         ctx[4]);
         add_location(a, file, 30, 2, 660);
         attr_dev(li, "class", "element");
         toggle_class(li, "visible",
         /*afficher*/
         ctx[3]);
         add_location(li, file, 29, 0, 611);
       },
       l: function claim(nodes) {
         throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
       },
   ...
   function instance($$self, $$props, $$invalidate) {
     ...
     onMount(function () {
       debugger;
       $$invalidate(2, possedeEnfants = !!thisComponent.querySelector('MenuSecondaireElement'));
     });
