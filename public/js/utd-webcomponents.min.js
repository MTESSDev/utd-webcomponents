var utd = (function (exports) {
   ...
   var file$9 = "src\\librairie\\components\\accordeon.svelte"; // (27:10) {#if titre}
   ...
   function create_dynamic_element$1(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         add_location(slot, file$9, 29, 10, 939);
         attr_dev(span0, "class", "titre");
         add_location(span0, file$9, 25, 8, 846);
         attr_dev(span1, "class", span1_class_value = "utd-icone-svg " + (
         /*reduit*/
         ctx[0] === 'false' ? 'moins' : 'plus'));
         add_location(span1, file$9, 31, 8, 993);
         ...
         /*reduit*/
         ctx[0] === 'false');
         add_location(button, file$9, 24, 6, 706);
         set_attributes(svelte_element, svelte_element_data);
         add_location(svelte_element, file$9, 23, 4, 651);
       },
       m: function mount(target, anchor) {
   ...
   function create_if_block$6(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         add_location(div, file$9, 38, 8, 1214);
       },
       m: function mount(target, anchor) {
   ...
   function create_else_block$2(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         t = space();
         slot1 = element("slot");
         add_location(slot0, file$9, 42, 12, 1360);
         attr_dev(slot1, "name", "contenu");
         add_location(slot1, file$9, 43, 12, 1383);
       },
       m: function mount(target, anchor) {
   ...
   var file$8 = "src\\librairie\\components\\avis.svelte"; // (23:6) {#if contenu}
   ...
   function create_fragment$8(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         /*type*/
         ctx[1]);
         add_location(div0, file$8, 15, 4, 435);
         attr_dev(div1, "class", "zone-icone");
         add_location(div1, file$8, 14, 2, 405);
         attr_dev(h2, "class", "titre");
         add_location(h2, file$8, 18, 4, 545);
         attr_dev(slot, "name", "contenu");
         add_location(slot, file$8, 25, 6, 687);
         attr_dev(div2, "class", "texte");
         add_location(div2, file$8, 21, 4, 595);
         attr_dev(div3, "class", "contenu zone-html");
         add_location(div3, file$8, 17, 2, 508);
         ...
         add_location(div4, file$8, 13, 0, 286);
         attr_dev(link, "rel", "stylesheet");
         attr_dev(link, "href", "/css/utd-webcomponents.min.css");
         add_location(link, file$8, 30, 0, 744);
       },
       l: function claim(nodes) {
         throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
       },
   ...
   function create_fragment$7(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         link = element("link");
         this.c = noop;
         add_location(slot, file$7, 330, 0, 9856);
         attr_dev(link, "rel", "stylesheet");
         attr_dev(link, "href", "/css/utd-webcomponents.min.css");
         add_location(link, file$7, 334, 0, 9871);
       },
       l: function claim(nodes) {
         throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
       },
   ...
   function instance$7($$self, $$props, $$invalidate) {
     ...
     function ajusterChampAriaDescribedBy() {
       ...
       if (type === 'radio' || type === 'checkbox') ; //      controle = 
     ...
     function gererErreur() {
       ...
       if (invalide === 'true') {
         ...
         var descByAvant = elementChamp.getAttribute('aria-describedby');
         elementChamp.setAttribute('aria-describedby', elementErreur.id);
         elementChamp.setAttribute('aria-invalid', 'true'); //setTimeout nécessaire pour lecteur écran

         if (descByAvant) {
           setTimeout(function () {
             elementChamp.setAttribute('aria-describedby', "".concat(descByAvant, " ").concat(idElementErreur));
           }, 100);
         }
     ...
     Object.keys($$props).forEach(function (key) {
       if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$1.warn("<utd-champ-form> was created with unknown prop '".concat(key, "'"));
     });
     ...
     $$self.$capture_state = function () {
       return {
         ...
         gererErreurCheckboxRadio: gererErreurCheckboxRadio
       };
     };
   ...
   function create_else_block$1(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         /*label*/
         ctx[2]);
         add_location(span, file$2, 214, 6, 6566);
         attr_dev(a, "href",
         /*href*/
         ctx[3]);
         ...
         /*indextab*/
         ctx[4]);
         add_location(a, file$2, 213, 4, 6408);
       },
       m: function mount(target, anchor) {
   ...
   function create_if_block$2(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         add_location(span0, file$2, 204, 6, 6089);
         attr_dev(span1, "aria-hidden", "true");
         attr_dev(span1, "class", "utd-icone-svg chevron-bleu-piv");
         add_location(span1, file$2, 205, 6, 6117);
         attr_dev(a, "role", "menuitem");
         attr_dev(a, "href",
         /*href*/
         ctx[3]);
         ...
         /*indextab*/
         ctx[4]);
         add_location(a, file$2, 203, 4, 5866);
       },
       m: function mount(target, anchor) {
         insert_dev(target, a, anchor);
         append_dev(a, span0);
   ...
   function create_if_block_1$1(ctx) {
     ...
     var block = {
       c: function create() {
         div = element("div");
         slot = element("slot");
         add_location(slot, file$2, 209, 8, 6353);
         attr_dev(div, "id",
         /*idSousMenu*/
         ctx[8]);
         attr_dev(div, "role", "menu");
         attr_dev(div, "class", "sous-menu");
         add_location(div, file$2, 208, 6, 6231);
       },
       m: function mount(target, anchor) {
         insert_dev(target, div, anchor);
         append_dev(div, slot);
   ...
   function create_fragment$2(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         /*estactif*/
         ctx[0] === 'true' ? 'active' : ''));
         add_location(div, file$2, 201, 0, 5707);
         attr_dev(link, "rel", "stylesheet");
         attr_dev(link, "href", "/css/utd-webcomponents.min.css");
         add_location(link, file$2, 218, 0, 6631);
       },
       l: function claim(nodes) {
         throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
       },
   ...
   var file = "src\\librairie\\components\\tableMatieres.svelte";
   ...
   function create_if_block(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         add_location(h2, file, 35, 4, 803);
         add_location(ul, file, 37, 6, 900);
         attr_dev(nav, "aria-describedby", "titreTableMatieres");
         add_location(nav, file, 36, 4, 849);
         attr_dev(div, "class", "utd-component utd-tablematieres");
         add_location(div, file, 34, 2, 752);
       },
       m: function mount(target, anchor) {
         insert_dev(target, div, anchor);
         append_dev(div, h2);
   ...
   function create_each_block(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         /*ancre*/
         ctx[4].id);
         add_location(a, file, 40, 12, 967);
         add_location(li, file, 39, 10, 949);
       },
       m: function mount(target, anchor) {
   ...
   function create_fragment(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         attr_dev(link, "rel", "stylesheet");
         attr_dev(link, "href", "/css/utd-webcomponents.min.css");
         add_location(link, file, 48, 0, 1114);
       },
       l: function claim(nodes) {
         throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
       },
   ...
   function instance($$self, $$props, $$invalidate) {
     var _$$props$$$slots = $$props.$$slots,
         slots = _$$props$$$slots === void 0 ? {} : _$$props$$$slots;
         $$props.$$scope;
     validate_slots('utd-tablematieres', slots, []);
     var _$$props$titre = $$props.titre,
         titre = _$$props$titre === void 0 ? Utils.obtenirLanguePage() === 'fr' ? "Dans cette page :" : "On this page:" : _$$props$titre;
     var _$$props$selecteuranc = $$props.selecteurancres,
         selecteurancres = _$$props$selecteuranc === void 0 ? '.ancre' : _$$props$selecteuranc;
     var ancres;
     onMount(function () {
     ...
     function obtenirAncres() {
       var ancres = document.querySelectorAll(selecteurancres); //Ajouter un id aux ancres qui n'en n'auraient pas
     ...
     var writable_props = ['titre', 'selecteurancres'];
     Object.keys($$props).forEach(function (key) {
       if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn("<utd-tablematieres> was created with unknown prop '".concat(key, "'"));
     });

     $$self.$$set = function ($$props) {
       if ('titre' in $$props) $$invalidate(0, titre = $$props.titre);
       if ('selecteurancres' in $$props) $$invalidate(2, selecteurancres = $$props.selecteurancres);
     };
     ...
     $$self.$capture_state = function () {
       return {
         ...
         Utils: Utils,
         titre: titre,
         selecteurancres: selecteurancres,
         ancres: ancres,
     ...
     return [titre, ancres, selecteurancres];
   }

   var TableMatieres = /*#__PURE__*/function (_SvelteElement) {
     _inherits(TableMatieres, _SvelteElement);

     var _super = _createSuper(TableMatieres);

     function TableMatieres(options) {
       var _this;

       _classCallCheck(this, TableMatieres);
     ...
     _createClass(TableMatieres, [{
       ...
       set: function set(selecteurancres) {
         this.$$set({
           selecteurancres: selecteurancres
         });
         flush();
       ...
       key: "observedAttributes",
       get: function get() {
         return ["titre", "selecteurancres"];
       }
     }]);

     return TableMatieres;
   }(SvelteElement);

   customElements.define("utd-tablematieres", TableMatieres);
