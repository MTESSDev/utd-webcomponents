var utd = (function (exports) {
   ...
   var file$2 = "src\\librairie\\components\\dialogueModal.svelte"; // (149:0) {#if estModaleAffichee}
   ...
   function create_if_block$1(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         add_location(div0, file$2, 149, 2, 5270);
         attr_dev(span, "aria-hidden", "true");
         attr_dev(span, "class", "utd-icone-svg x-fermer-bleu");
         add_location(span, file$2, 174, 8, 6170);
         attr_dev(button, "type", "button");
         attr_dev(button, "class", "close");
         attr_dev(button, "aria-label",
         /*srTexteBoutonFermer*/
         ctx[9]);
         add_location(button, file$2, 168, 8, 6000);
         attr_dev(h1, "id",
         /*idEntete*/
         ctx[7]);
         attr_dev(h1, "class", "titre-dialog");
         add_location(h1, file$2, 184, 10, 6497);
         attr_dev(div1, "class", div1_class_value = "entete " + (
         /*type*/
         ctx[0] ? 'avec-type' : ''));
         add_location(div1, file$2, 180, 8, 6322);
         attr_dev(slot, "name", "contenu");
         add_location(slot, file$2, 189, 10, 6644);
         attr_dev(div2, "class", "corps");
         attr_dev(div2, "id",
         /*idCorps*/
         ctx[8]);
         add_location(div2, file$2, 188, 8, 6600);
         attr_dev(div3, "class", "principal");
         add_location(div3, file$2, 179, 6, 6289);
         attr_dev(div4, "class", "conteneur");
         add_location(div4, file$2, 167, 4, 5967);
         ...
         add_location(div5, file$2, 150, 2, 5350);
       },
       m: function mount(target, anchor) {
     ...
     dispatch_dev("SvelteRegisterBlock", {
       ...
       type: "if",
       source: "(149:0) {#if estModaleAffichee}",
       ctx: ctx
     });
     return block;
   } // (182:10) {#if type}
   ...
   function create_if_block_2$1(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         ctx[0]);
         attr_dev(span, "aria-hidden", "true");
         add_location(span, file$2, 182, 12, 6404);
       },
       m: function mount(target, anchor) {
     ...
     dispatch_dev("SvelteRegisterBlock", {
       ...
       type: "if",
       source: "(182:10) {#if type}",
       ctx: ctx
     });
     return block;
   } // (192:8) {#if Utils.slotExiste(slots, 'pied')}
   ...
   function create_if_block_1$1(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         add_location(slot, file$2, 193, 12, 6774);
         attr_dev(div, "class", "pied");
         add_location(div, file$2, 192, 10, 6742);
       },
       m: function mount(target, anchor) {
         insert_dev(target, div, anchor);
         append_dev(div, slot);
     ...
     dispatch_dev("SvelteRegisterBlock", {
       ...
       type: "if",
       source: "(192:8) {#if Utils.slotExiste(slots, 'pied')}",
       ctx: ctx
     });
     return block;
   }
   ...
   function create_fragment$2(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         attr_dev(link, "rel", "stylesheet");
         attr_dev(link, "href", "/css/utd-webcomponents.min.css");
         add_location(link, file$2, 201, 0, 6884);
       },
       l: function claim(nodes) {
         throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
       },
   ...
   function scrollIntoViewIfNeeded(target) {
     ...
     if (target.getBoundingClientRect().bottom > window.innerHeight) {
       console.log("scroolIntoView(false)"); //  The bottom of the target will be aligned to the bottom of the visible area of the scrollable ancestor.
   ...
   function instance$2($$self, $$props, $$invalidate) {
     ...
     function donnerfocusPremierElementFocusable(modale) {
       ...
       if (!premierElementFocusable) {
         ...
         var elementsFocusables = elementsFocusablesRoot.concat(elementsFocusablesShadow); //      elementsFocusables.addEventListener('focus',function(e){/*some code */}, true);

         elementsFocusables.forEach(function (element) {
