var utd = (function (exports) {
  ...
  */
  ...
  _defineProperty(Utils, "cssFullPath", "".concat(Utils.cssRelativePath, "utd-webcomponents.min.css?v=1.7.3"));
  ...
  var file$2 = "src\\librairie\\components\\pivEntete.svelte"; // (38:0) {#if passerContenu === 'true'}
  ...
  function create_if_block_9(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        add_location(a, file$2, 40, 8, 1451);
        attr_dev(div0, "class", "utd-passer-contenu");
        add_location(div0, file$2, 39, 4, 1409);
        attr_dev(div1, "class", "utd-conteneur-passer-contenu");
        add_location(div1, file$2, 38, 2, 1361);
      },
      m: function mount(target, anchor) {
        insert_dev(target, div1, anchor);
        append_dev(div1, div0);
  ...
  function create_if_block_8(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        add_location(span, file$2, 57, 12, 2020);
      },
      m: function mount(target, anchor) {
        insert_dev(target, span, anchor);
        append_dev(span, t);
  ...
  function create_if_block_7(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        add_location(slot, file$2, 65, 12, 2273);
        attr_dev(div, "class", "bouton-recherche");
        add_location(div, file$2, 64, 10, 2229);
      },
      m: function mount(target, anchor) {
        insert_dev(target, div, anchor);
        append_dev(div, slot);
  ...
  function create_if_block_4(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        t = space();
        if (if_block1) if_block1.c();
        add_location(ul, file$2, 74, 12, 2521);
      },
      m: function mount(target, anchor) {
  ...
  function create_if_block_3(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        add_location(slot, file$2, 71, 10, 2409);
      },
      m: function mount(target, anchor) {
        insert_dev(target, slot, anchor);
      },
  ...
  function create_if_block_6(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        /*urlLangueAlternative*/
        ctx[7]);
        add_location(a, file$2, 76, 20, 2589);
        add_location(li, file$2, 76, 16, 2585);
      },
      m: function mount(target, anchor) {
        insert_dev(target, li, anchor);
        append_dev(li, a);
  ...
  function create_if_block_5(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        /*urlNousJoindre*/
        ctx[9]);
        add_location(a, file$2, 79, 20, 2750);
        add_location(li, file$2, 79, 16, 2746);
      },
      m: function mount(target, anchor) {
        insert_dev(target, li, anchor);
        append_dev(li, a);
  ...
  function create_if_block_2(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        ctx[4]);
        attr_dev(span, "class", "description");
        add_location(span, file$2, 90, 10, 3059);
      },
      m: function mount(target, anchor) {
        insert_dev(target, span, anchor);
        append_dev(span, t);
  ...
  function create_if_block_1(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        add_location(slot, file$2, 96, 10, 3251);
        attr_dev(div, "class", "bouton-recherche");
        add_location(div, file$2, 95, 8, 3209);
      },
      m: function mount(target, anchor) {
        insert_dev(target, div, anchor);
        append_dev(div, slot);
  ...
  function create_if_block$2(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        add_location(slot, file$2, 102, 8, 3445);
        attr_dev(div, "class", "zone-recherche");
        add_location(div, file$2, 101, 6, 3407);
      },
      m: function mount(target, anchor) {
        insert_dev(target, div, anchor);
        append_dev(div, slot);
  ...
  function create_fragment$2(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        add_location(img, file$2, 50, 10, 1786);
        attr_dev(a0, "href",
        /*urlLogo*/
        ctx[0]);
        add_location(a0, file$2, 49, 8, 1754);
        attr_dev(div0, "class", "section-gauche signature-gouvernement");
        add_location(div0, file$2, 48, 6, 1693);
        add_location(span0, file$2, 55, 10, 1953);
        attr_dev(a1, "href",
        /*urlTitreSite*/
        ctx[5]);
        attr_dev(a1, "class", "titre-site");
        add_location(a1, file$2, 54, 8, 1897);
        attr_dev(div1, "class", "section-centre");
        add_location(div1, file$2, 53, 6, 1859);
        attr_dev(div2, "class", "section-droite");
        add_location(div2, file$2, 62, 6, 2131);
        attr_dev(div3, "class", "conteneur-sections");
        add_location(div3, file$2, 47, 4, 1653);
        add_location(span1, file$2, 88, 8, 2996);
        attr_dev(div4, "class", "titre-site");
        add_location(div4, file$2, 87, 6, 2962);
        attr_dev(div5, "class", "zone-titre-recherche");
        add_location(div5, file$2, 86, 4, 2920);
        attr_dev(div6, "class", "utd-container");
        add_location(div6, file$2, 46, 2, 1620);
        attr_dev(div7, "class", "utd-piv-entete");
        add_location(div7, file$2, 45, 0, 1588);
        attr_dev(link, "rel", "stylesheet");
        attr_dev(link, "href", Utils.cssFullPath);
        add_location(link, file$2, 111, 0, 3535);
      },
      l: function claim(nodes) {
        throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
      },
  ...
  function instance$2($$self, $$props, $$invalidate) {
    ...
    var _$$props$srcLogo = $$props.srcLogo,
        srcLogo = _$$props$srcLogo === void 0 ? "".concat(Utils.imagesRelativePath, "utd-sprite.svg?v=1.7.3#QUEBEC_blanc") : _$$props$srcLogo;
  ...
  function create_if_block$1(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        add_location(h2, file$1, 40, 4, 1596);
        attr_dev(slot, "name", "liens");
        add_location(slot, file$1, 42, 6, 1736);
        attr_dev(nav, "aria-labelledby", "utdTitreLiensPivPiedPage");
        add_location(nav, file$1, 41, 4, 1680);
        attr_dev(div, "class", "liens");
        add_location(div, file$1, 39, 2, 1571);
      },
      m: function mount(target, anchor) {
        insert_dev(target, div, anchor);
        append_dev(div, h2);
  ...
  function create_fragment$1(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        /*heightLogo*/
        ctx[5]);
        add_location(img, file$1, 48, 6, 1861);
        attr_dev(a0, "href",
        /*urlLogo*/
        ctx[1]);
        attr_dev(a0, "target", "_blank");
        attr_dev(a0, "rel", "noopener");
        add_location(a0, file$1, 47, 2, 1802);
        attr_dev(span0, "class", "utd-sr-only");
        add_location(span0, file$1, 54, 10, 2144);
        attr_dev(a1, "href",
        /*urlCopyright*/
        ctx[8]);
        attr_dev(a1, "target", "_blank");
        attr_dev(a1, "rel", "noopener");
        add_location(a1, file$1, 52, 6, 2032);
        attr_dev(span1, "class", "copyright");
        add_location(span1, file$1, 51, 2, 2000);
        attr_dev(div, "class", "utd-container utd-piv-pied-page");
        add_location(div, file$1, 36, 0, 1476);
        attr_dev(link, "rel", "stylesheet");
        attr_dev(link, "href", Utils.cssFullPath);
        add_location(link, file$1, 60, 0, 2250);
      },
      l: function claim(nodes) {
        throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
      },
