var utd = (function (exports) {
   ...
   var file = "src\\librairie\\components\\menuVerticalItem.svelte"; // (104:2) {:else}
   ...
   function create_else_block(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         /*label*/
         ctx[2]);
         add_location(span, file, 105, 6, 3121);
         attr_dev(a, "href",
         /*href*/
         ctx[3]);
         ...
         add_location(a, file, 104, 4, 3027);
       },
       m: function mount(target, anchor) {
   ...
   function create_if_block(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         add_location(span0, file, 95, 6, 2708);
         attr_dev(span1, "aria-hidden", "true");
         attr_dev(span1, "class", "utd-icone-svg chevron-bleu-piv");
         add_location(span1, file, 96, 6, 2736);
         attr_dev(a, "role", "menuitem");
         attr_dev(a, "href",
         /*href*/
         ctx[3]);
     ...
     dispatch_dev("SvelteRegisterBlock", {
       ...
       type: "if",
       source: "(94:2) {#if possedeEnfants}",
       ctx: ctx
     });
     return block;
   } // (99:4) {#if afficher === 'true'}
   ...
   function create_if_block_1(ctx) {
     ...
     var block = {
       c: function create() {
         div = element("div");
         slot = element("slot");
         add_location(slot, file, 100, 8, 2972);
         attr_dev(div, "id",
         /*idSousMenu*/
         ctx[7]);
         attr_dev(div, "role", "menu");
         attr_dev(div, "class", "sous-menu");
         add_location(div, file, 99, 6, 2850);
       },
       m: function mount(target, anchor) {
         insert_dev(target, div, anchor);
         append_dev(div, slot);
   ...
   function create_fragment(ctx) {
     ...
     var block = {
       c: function create() {
         ...
         /*estactif*/
         ctx[0] === 'true' ? 'active' : ''));
         add_location(div, file, 92, 0, 2367);
         attr_dev(link, "rel", "stylesheet");
         attr_dev(link, "href", "/css/utd-webcomponents.min.css");
         add_location(link, file, 109, 0, 3186);
       },
       l: function claim(nodes) {
         throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
       },
